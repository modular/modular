...
if(MODULAR_RELEASE_PACKAGE_BUILD)
  set(MODULAR_VERSION_STRING "\"${MODULAR_VERSION_MAJOR}.${MODULAR_VERSION_MINOR}.${MODULAR_VERSION_PATCH}\"")
else()
  set(MODULAR_VERSION_STRING "\"${MODULAR_VERSION_MAJOR}.${MODULAR_VERSION_MINOR}.${MODULAR_VERSION_PATCH}-${MODULAR_VERSION_REVISION}-${MODULAR_BUILD_TYPE_LOWER}\"")
endif()
