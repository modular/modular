...
| `KGEN/include/KGEN/MojoTooling/ParserDriver.h` | `MojoParserContext` — the tooling-facing parser driver                                                      |
| `KGEN/include/KGEN/MojoParser/EntryPoint.h`    | `ParserConfig` and the `ParserListener` interface                                                           |
...
(`KGEN/include/KGEN/MojoParser/SharedState.h`):
...
(`KGEN/include/KGEN/MojoTooling/ CodeComplete.h`): a list of
...
`KGEN/include/KGEN/MojoParser/EntryPoint.h`, lines 148–233), annotated with
