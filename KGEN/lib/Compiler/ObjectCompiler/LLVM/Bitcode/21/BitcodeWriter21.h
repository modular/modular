...
// Get this file from llvm-project/llvm/include/llvm/Bitcode/BitcodeWriter.h
// with tag llvmorg-21.1.8

#ifndef KGEN_COMPILER_LLVMIR_BITCODE_BITCODEWRITER21_H
#define KGEN_COMPILER_LLVMIR_BITCODE_BITCODEWRITER21_H
...
public:
  /// Create a BitcodeWriter21 that writes to Buffer.
  LLVM_ABI BitcodeWriter21(llvm::SmallVectorImpl<char> &Buffer);
  LLVM_ABI BitcodeWriter21(llvm::raw_ostream &FS);

  LLVM_ABI ~BitcodeWriter21();
  ...
  LLVM_ABI void copyStrtab(llvm::StringRef Strtab);
  ...
  LLVM_ABI void writeModule(const llvm::Module &M,
  ...
  LLVM_ABI void writeThinLinkBitcode(const llvm::Module &M,
                                     const llvm::ModuleSummaryIndex &Index,
                                     const llvm::ModuleHash &ModHash);

  LLVM_ABI void
  writeIndex(const llvm::ModuleSummaryIndex *Index,
             const llvm::ModuleToSummariesForIndexTy *ModuleToSummariesForIndex,
...
LLVM_ABI void
writeThinLinkBitcodeToFile21(const llvm::Module &M, llvm::raw_ostream &Out,
                             const llvm::ModuleSummaryIndex &Index,
                             const llvm::ModuleHash &ModHash);
...
LLVM_ABI void writeIndexToFile21(
    const llvm::ModuleSummaryIndex &Index, llvm::raw_ostream &Out,
    const llvm::ModuleToSummariesForIndexTy *ModuleToSummariesForIndex =
        nullptr,
...
/// were empty.
LLVM_ABI void embedBitcodeInModule21(llvm::Module &M, llvm::MemoryBufferRef Buf,
                                     bool EmbedBitcode, bool EmbedCmdline,
                                     const std::vector<uint8_t> &CmdArgs);

} // namespace M::KGEN::LLVM

#endif // KGEN_COMPILER_LLVMIR_BITCODE_BITCODEWRITER21_H
