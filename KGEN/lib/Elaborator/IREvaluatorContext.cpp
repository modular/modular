...
IREvaluatorContext::resolveStructInstanceType(TypedAttr typeRef,
                                              StringRef funcName) {
  // Unwrap the type reference to get to the underlying TypeInstanceRefAttr.
  ...
  ErrorTreeOr<StructInstanceOp> structInstanceOr =
      getConcreteStructTypeInstanceInternal(*errorLoc, instanceRef);
...
FailureOr<TypedAttr>
IREvaluatorContext::evaluateStructFieldTypesAttr(StructFieldTypesAttr attr) {
...
FailureOr<TypedAttr>
IREvaluatorContext::evaluateStructFieldNamesAttr(StructFieldNamesAttr attr) {
  FailureOr<StructInstanceType> structTypeOr =
...
FailureOr<TypedAttr> IREvaluatorContext::evaluateStructFieldIndexByNameAttr(
...
FailureOr<TypedAttr> IREvaluatorContext::evaluateStructFieldTypeByNameAttr(
