...
ParametricIREvaluator::evaluateStringPart(TypedAttr part) {
...
FailureOr<TypedAttr>
ParametricIREvaluator::evaluateDataToStr(ParamOperatorAttr op) {
...
FailureOr<TypedAttr>
ParametricIREvaluator::evaluateBindParams(BindParamsAttr bindParams) {
...
FailureOr<TypedAttr>
ParametricIREvaluator::evaluateGetEnv(ParamOperatorAttr op) {
...
void ParametricIREvaluator::printParamValue(raw_ostream &os, ParamDeclAttr decl,
                                            TypedAttr value,
...
std::string
ParametricIREvaluator::stringifyTypeInstanceRef(TypeInstanceRefAttr instanceRef,
                                                bool qualifiedBuiltins) {
  PParamNode *genNode =
