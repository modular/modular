...
using WrappedConcreteTypeConstantAttr =
    WrappedAttrType<ConcreteTypeConstantAttr>;
using WrappedParameterizedTypeConstantAttr =
    WrappedAttrType<ParameterizedTypeConstantAttr>;
