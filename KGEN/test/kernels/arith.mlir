...
// CHECK-LABEL: kgen.kernel @add_f32(%arg0: !meta.buffer<?, f32>, %arg1: !meta.buffer<?, f32>, %arg2: !meta.buffer<?, f32>)
// CHECK: kgen.call @"add_impl,type=f32"(%arg0, %arg1, %arg2) : (!meta.buffer<?, f32>, !meta.buffer<?, f32>, !meta.buffer<?, f32>) -> ()
kgen.kernel @add_f32(%in1: !meta.buffer<?, f32>, %in2: !meta.buffer<?, f32>, %out: !meta.buffer<?, f32>) {
