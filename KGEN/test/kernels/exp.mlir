...
kgen.generator.interface @exp<type: dtype>(!pop.simd<1, type>) -> !pop.simd<1, type>
...
// CHECK: kgen.call @"exp_intrinsic_f32,type=f32"(%[[V0]]) : (!pop.simd<1, f32>) -> !pop.simd<1, f32>
...
// CHECK: %[[V0:.*]] = pop.cast_from_builtin %[[ARG0]]
// CHECK: kgen.call @"exp_intrinsic_f64,type=f64"(%[[V0]]) : (!pop.simd<1, f64>) -> !pop.simd<1, f64>
