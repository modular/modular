...
// CHECK-LABEL: kgen.func @exp_f32
// CHECK-SAME: (%[[ARG0:.*]]: f32) -> f32
// CHECK: %[[V0:.*]] = meta.cast_from_builtin %[[ARG0]]
// CHECK: kgen.call @"exp_intrinsic_f32,type=f32"(%[[V0]]) : (!meta.scalar<f32>) -> !meta.scalar<f32>
...
// CHECK-LABEL: kgen.func @exp_f64
// CHECK-SAME: (%[[ARG0:.*]]: f64) -> f64
// CHECK: %[[V0:.*]] = meta.cast_from_builtin %[[ARG0]]
// CHECK: kgen.call @"exp_intrinsic_f64,type=f64"(%[[V0]]) : (!meta.scalar<f64>) -> !meta.scalar<f64>
