...
kgen.func @nested_break(%arg0: i1) {
  // CHECK-NEXT: llvm.br ^bb1
  hlcf.loop {
    // CHECK-NEXT: ^bb1:
    // CHECK-NEXT: llvm.cond_br %arg0, ^bb2, ^bb3
...
kgen.func @deeply_nested(%arg0: i1, %arg1: i1, %arg2: i1) {
...
kgen.func @operands_and_results(%arg0: i1, %arg1: i32, %arg2: i64) -> (i32, i64) {
...
kgen.func @multiple_return(%arg0: i1) -> (i1, i1) {
  hlcf.if %arg0 {
    // CHECK: ^bb1:
    // CHECK-NEXT: %[[S0:.*]] = llvm.mlir.undef
    // CHECK-NEXT: %[[S1:.*]] = llvm.insertvalue %arg0, %[[S0]][0]
    // CHECK-NEXT: %[[S2:.*]] = llvm.insertvalue %arg0, %[[S1]][1]
    // CHECK-NEXT: llvm.return %[[S2]]
    kgen.return %arg0, %arg0 : i1, i1
  } else {
    hlcf.yield
  }
  kgen.return %arg0, %arg0 : i1, i1
