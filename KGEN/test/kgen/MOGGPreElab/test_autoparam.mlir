...
kgen.generator @function_calling_func_with_attr<type: dtype, rank>(%arg0: !kgen.pointer<struct<() memoryOnly>> borrow_in_mem, %arg1: !kgen.pointer<struct<() memoryOnly>> borrow_in_mem) -> !kgen.none attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["a", "b"], mogg.arg_type_names = ["tensor_utils::ManagedTensorSlice", "tensor_utils::ManagedTensorSlice"]} {
  %0 = kgen.call @function_with_attr<:dtype type, rank>(%arg1) : (!kgen.pointer<struct<() memoryOnly>> borrow_in_mem) -> !kgen.none
  %none = kgen.param.constant: none = <#kgen.none>
  kgen.return %none : !kgen.none
}

kgen.generator export @some_kernel<spec: struct<() memoryOnly>, type: dtype, rank>(%arg0: !kgen.pointer<struct<() memoryOnly>> inout, %arg1: !kgen.pointer<struct<() memoryOnly>> borrow_in_mem, %arg2: !kgen.pointer<struct<() memoryOnly>> borrow_in_mem) attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["c", "a", "b"], mogg.arg_type_names = ["tensor_utils::ManagedTensorSlice", "tensor_utils::ManagedTensorSlice", "tensor_utils::ManagedTensorSlice"], mogg.execute = "some_kernel" : !kgen.string, mogg.spec = "spec"} {
  %0 = kgen.call @function_with_attr<:dtype type, rank>(%arg1) : (!kgen.pointer<struct<() memoryOnly>> borrow_in_mem) -> !kgen.none
