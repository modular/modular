...
kgen.generator  @function_with_attr<type: dtype, rank>(%arg0: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> borrow_in_mem) -> !kgen.none attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["x"], mogg.arg_type_names = ["tensor_utils::UnsafeTensorSlice"]} {
...
kgen.generator  @function_calling_func_with_attr<type: dtype, rank>(%arg0: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> borrow_in_mem, %arg1: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> borrow_in_mem) -> !kgen.none attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["x", "y"], mogg.arg_type_names = ["tensor_utils::UnsafeTensorSlice", "tensor_utils::UnsafeTensorSlice"]} {
...
kgen.generator  export @some_kernel<type: dtype, rank>(%arg0: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> inout, %arg1: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> borrow_in_mem, %arg2: !kgen.pointer<struct<(pointer<none>, array<rank, index>, array<rank, index>) memoryOnly>> borrow_in_mem) attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["out", "x", "y"], mogg.arg_type_names = ["tensor_utils::UnsafeTensorSlice", "tensor_utils::UnsafeTensorSlice", "tensor_utils::UnsafeTensorSlice"], mogg.execute = "test_func" : !kgen.string} {
