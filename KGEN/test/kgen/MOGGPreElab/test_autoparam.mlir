...
kgen.generator export @specsof<T: type>(%arg0: !kgen.string, %arg1: !kgen.pointer<struct<(variadic<index>, variadic<index>, variant<<index>(!pop.array<apply(:() -> index get_type_method(T, "_get_static_rank")), index>) capturing -> !pop.simd<*(0,0), apply(:() -> !kgen.dtype get_type_method(T, "_get_dtype"))>, i1>, variant<<index>(!pop.array<apply(:() -> index get_type_method(T, "_get_static_rank")), index>, !pop.simd<*(0,0), apply(:() -> !kgen.dtype get_type_method(T, "_get_dtype"))>) capturing -> !kgen.none, i1>) memoryOnly>> byref_result) -> !kgen.none attributes {mogg.tensor_spec_hook} {
