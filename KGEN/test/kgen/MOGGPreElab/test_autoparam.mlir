...
// CHECK-NEXT: kgen.call @function_with_attr_{{[[0-9]]*}}<:dtype type, rank, :struct<(variadic<index>, variadic<index>) memoryOnly> __MOGG_SPEC0>
// CHECK-NEXT: kgen.call @function_calling_func_with_attr_{{[[0-9]]*}}<:dtype type, rank, :struct<(variadic<index>, variadic<index>) memoryOnly> __MOGG_SPEC1>
