...
// be used for testing.
#type_value = #kgen.type<struct<() memoryOnly>, {"_get_dtype" : () -> !kgen.dtype = @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_dtype()"<:dtype type, rank>, "_get_static_rank" : () -> index = @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_static_rank()"<:dtype type, rank>, "__del__" : (!kgen.pointer<struct<() memoryOnly>> owned_in_mem) -> !kgen.none = @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::__del__(tensor_internal::managed_tensor_slice::ManagedTensorSlice[$0, $1])"<:dtype type, rank>}> : !kgen.type
module {
...
kgen.generator @function_with_attr<type: dtype, rank>(%arg0: !kgen.pointer<struct<() memoryOnly>> read_mem) -> !kgen.none attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["a"], mogg.arg_type_names = ["tensor_internal::ManagedTensorSlice"]} {
  kgen.param.declare *"spec`1": struct<(variadic<index>, variadic<index>, variant<<index>(!pop.array<apply(:() -> index @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_static_rank()"<:dtype type, rank>), index>) capturing -> !pop.simd<*(0,0), apply(:() -> !kgen.dtype @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_dtype()"<:dtype type, rank>)>, i1>, variant<<index>(!pop.array<apply(:() -> index @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_static_rank()"<:dtype type, rank>), index>, !pop.simd<*(0,0), apply(:() -> !kgen.dtype @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_dtype()"<:dtype type, rank>)>) capturing -> !kgen.none, i1>)> = <apply(:(!kgen.string) -> !kgen.struct<(variadic<index>, variadic<index>, variant<<index>(!pop.array<apply(:() -> index @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_static_rank()"<:dtype type, rank>), index>) capturing -> !pop.simd<*(0,0), apply(:() -> !kgen.dtype @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_dtype()"<:dtype type, rank>)>, i1>, variant<<index>(!pop.array<apply(:() -> index @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_static_rank()"<:dtype type, rank>), index>, !pop.simd<*(0,0), apply(:() -> !kgen.dtype @"tensor_internal::managed_tensor_slice::ManagedTensorSlice::_get_dtype()"<:dtype type, rank>)>) capturing -> !kgen.none, i1>)> @specsof<:type #type_value>, "a")>
...
kgen.generator @function_calling_func_with_attr<type: dtype, rank>(%arg0: !kgen.pointer<struct<() memoryOnly>> read_mem, %arg1: !kgen.pointer<struct<() memoryOnly>> read_mem) -> !kgen.none attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["a", "b"], mogg.arg_type_names = ["tensor_internal::ManagedTensorSlice", "tensor_internal::ManagedTensorSlice"]} {
...
kgen.generator export @some_kernel<spec: struct<() memoryOnly>, type: dtype, rank>(%arg0: !kgen.pointer<struct<() memoryOnly>> mut, %arg1: !kgen.pointer<struct<() memoryOnly>> read_mem, %arg2: !kgen.pointer<struct<() memoryOnly>> read_mem) attributes {mogg.arg_params = [[#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index], [#kgen.param.decl.ref<"type"> : !kgen.dtype, #kgen.param.decl.ref<"rank"> : index]], mogg.arg_src_names = ["c", "a", "b"], mogg.arg_type_names = ["tensor_internal::ManagedTensorSlice", "tensor_internal::ManagedTensorSlice", "tensor_internal::ManagedTensorSlice"], mogg.execute = "some_kernel" : !kgen.string, mogg.spec = "spec"} {
  %0 = kgen.call @function_with_attr<:dtype type, rank>(%arg1) : (!kgen.pointer<struct<() memoryOnly>> read_mem) -> !kgen.none
