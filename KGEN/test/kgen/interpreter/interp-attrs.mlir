...
// CHECK-DAG: [[SYM:#.*]] = #interp.memory_handle<8, "0x04855811B0">
...
#sym = #interp.memory_handle<8, "0x04855811B0">
...
// CHECK: #interp.memref<[([[SYM]], heap, [], [0])], 0, 0> : (index) -> index
"some.op"() {a = #interp.memref<[(#sym, heap, [], [0])], 0, 0> : (index) -> index} : () -> ()
