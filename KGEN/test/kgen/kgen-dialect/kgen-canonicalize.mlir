...
kgen.generator @struct_get<x: index>() -> (si4, !kgen.param<#kgen.variadic.get<:!kgen.param_list<type> [si4, ui4], x>>) {
  ...
  kgen.return %1, %3 : si4, !kgen.param<#kgen.variadic.get<:!kgen.param_list<type> [si4, ui4], x>>
}
