...
// xpected-error @below {{index reference type 'index' does not match parameter type 'ui32'}}
...
// xpected-error @below {{index reference type 'index' does not match parameter type 'i32'}}
