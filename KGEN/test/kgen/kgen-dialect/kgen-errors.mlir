...
// xpected-error @below {{type of index reference #kgen.param.index.ref<0, false, 0> : index does not match parameter type 'ui32'}}
...
kgen.generator @callee(%owned: !kgen.pointer<i32> byref) {
  kgen.return
}
...
// xpected-error @below {{type of index reference #kgen.param.index.ref<0, false, 0> : index does not match parameter type 'i32'}}
