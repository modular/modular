...
// CHECK-SAME: aux = #kgen.fn_metadata<[read, read_mem, owned, owned_in_mem, deinit_mem, mut, ref, mutref, byref_error, byref_result], "none"> : !kgen.non_struct_type
"fn_metadata.conventions"() {aux = #kgen.fn_metadata<
  [read, read_mem, owned, owned_in_mem, deinit_mem, mut, ref, mutref,
...
// CHECK-SAME: aux = #kgen.fn_metadata<[read, mut], "throws", #lit.fn_meta_origin_data<2>> : !kgen.non_struct_type
"fn_metadata.metadata"() {
  aux = #kgen.fn_metadata<[read, mut], "throws", #lit.fn_meta_origin_data<2>>
} : () -> ()
...
// CHECK-SAME: aux = #kgen.fn_metadata<[read], "async"> : !kgen.non_struct_type
"fn_metadata.explicit_type"() {
  aux = #kgen.fn_metadata<[read], "async"> : !kgen.non_struct_type
} : () -> ()
