...
// CHECK-SAME: () -> !kgen.func_gen_type_builder<#kgen.param.decl.ref<"Ps"> : !kgen.non_struct_type, #kgen.param.decl.ref<"Ts"> : !kgen.param_list<type>, #kgen.param.decl.ref<"R"> : !kgen.type, #kgen.fn_metadata<[read, mut], "throws"> : !kgen.non_struct_type>
"func_gen_type_builder.symbolic"() : () -> !kgen.func_gen_type_builder<
  #kgen.param.decl.ref<"Ps"> : !kgen.non_struct_type,
