...
kgen.func export C @someBufferKernel(%a: !pop.struct<pointer<simd<1, invalid>>, index, !kgen.dtype>) -> index {
...
kgen.func export C @someNDBufferKernel(%a: !pop.struct<pointer<simd<1, invalid>>, index, array<5, index>, !kgen.dtype>) -> index {
...
kgen.func export C @oneElemStruct(%arg0: i32) -> !pop.struct<i32> {
...
kgen.func export C @twoElemStruct(%arg0: i32) -> !pop.struct<i32, i32> {
...
kgen.func export C @oneVariadic(%arg0: !kgen.variadic<f32>) -> !pop.struct<i32> {
  %0 = kgen.param.constant: struct<i32> = <{ 0 }>
  kgen.return %0 : !pop.struct<i32>
}
...
kgen.func export C @twoVariadic(%arg0: !kgen.variadic<!pop.struct<i32, i32>>,
