...
// CHECK: #lit.fn_metadata<["someRef", "v"], [pos, kw], ["someParam", "paramWithDefault"], [13 : index, 17 : i64], [3.140000e+00 : f32]>
"some.op"() {metadata = #lit.fn_metadata<["someRef", "v"], [pos, kw], ["someParam", "paramWithDefault"], [13 : index, 17: i64], [3.14: f32]>} : () -> ()
