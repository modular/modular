...
lit.struct.decl @S attributes {
  ...
  lit.func @__init__[mut selflife](%self: !lit.ref<@S, mut selflife> byref_result, |) -> !kgen.none attributes {sourceName = "__init__", specialFnKind = 2 : i8} {
...
lit.func @elifInitError[mut *"__result__`0"](?, %cond: i1, %__result__[__result__]: !lit.ref<@S, mut *"__result__`0"> byref_result) -> !kgen.none {
  hlcf.elif {
    ...
    %0 = lit.call @S::@__init__[mut *"__result__`0"](%__result__) : !lit.signature<[1](!lit.ref<@S, mut *"__result__`0"> byref_result, |) -> !kgen.none>
    hlcf.yield
  } else {
    hlcf.yield
  }
