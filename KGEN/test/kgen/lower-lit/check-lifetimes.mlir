...
lit.file_module @check_lifetimes {
  ...
  lit.struct.decl @Struct {
    ...
    lit.func @__del__(%self: !kgen.pointer<@check_lifetimes::@Struct> owned_in_mem) -> !kgen.none {
      %none = kgen.param.constant: none = <#kgen.none>
      kgen.return %none : !kgen.none
    }
  }
  ...
  lit.func @useDtor(
    ...
    %b: !kgen.pointer<@check_lifetimes::@Struct> owned_in_mem) -> !kgen.none {
    ...
    %0 = kgen.call @check_lifetimes::@Struct::@"__init__check_lifetimes:Struct=&)"(%1) : (!kgen.pointer<@check_lifetimes::@Struct> byref_result) -> !kgen.none
...
lit.struct.decl @S attributes {destructor = #kgen.symbol.constant<@S::@"__del__" > : !kgen.signature<(!kgen.pointer<@S> owned_in_mem) -> !kgen.none>} {
  ...
  lit.func @__del__(%self: !kgen.pointer<@S> owned_in_mem) -> !kgen.none {
    %none = kgen.param.constant: none = <#kgen.none>
    kgen.return %none : !kgen.none
  }
}
...
lit.func @verify_destructor_post_throw() -> !kgen.none {
  lit.try {
    ...
    %1 = kgen.call @foo(%xptr) : (!kgen.pointer<@S> byref_result) throws -> !kgen.variant<@Error, none>
...
lit.func @verify_callee_destroys(%c: i1) -> !kgen.none {
  ...
  %2 = kgen.call @S::@__init__(%sptr) : (!kgen.pointer<@S> init_self) -> !kgen.none
  lit.try {
    hlcf.if %c {
      %5 = kgen.call @mightThrow() : () throws -> !kgen.variant<@Error, none>
...
lit.struct.decl @DestructSome attributes {destructor = #kgen.symbol.constant<@DestructSome::@__del__> : !kgen.signature<(!kgen.pointer<@DestructSome> owned_in_mem) -> !kgen.none>} {
  ...
  lit.func @__init__(%self: !kgen.pointer<@DestructSome> init_self, %cond: i1,
    ...
    %1 = kgen.call @S::@__copyinit__(%0, %x) : (!kgen.pointer<@S> init_self, !kgen.pointer<@S> borrow_in_mem) -> !kgen.none
    ...
    %104 = kgen.call @S::@__moveinit__(%103, %takeMe) : (!kgen.pointer<@S> init_self, !kgen.pointer<@S> owned_in_mem) -> !kgen.none
    ...
    // CHECK-NEXT: [[VAR5:%.*]] = kgen.call @S::@__del__([[VAR4]]) : (!kgen.pointer<@S> owned_in_mem) -> !kgen.none
    // CHECK-NEXT: [[VAR6:%.*]] = lit.struct.gep %self[byinit] : <@S> from <@DestructSome>
    // CHECK-NEXT: [[VAR7:%.*]] = kgen.call @S::@__del__([[VAR6]]) : (!kgen.pointer<@S> owned_in_mem) -> !kgen.none
...
lit.struct.decl @HasMemFields attributes {destructor = #kgen.symbol.constant<@HasMemFields::@__del__> : !kgen.signature<(!kgen.pointer<@HasMemFields> owned_in_mem) -> !kgen.none>} {
  ...
  lit.func @__del__(%self: !kgen.pointer<@HasMemFields> owned_in_mem) -> !kgen.none {
    ...
    // CHECK: %[[VAR1:.*]] = kgen.call @S::@__del__(%[[VAR0]]) : (!kgen.pointer<@S> owned_in_mem) -> !kgen.none
    // CHECK: %[[VAR2:.*]] = lit.struct.gep %self[stole] : <@S> from <@HasMemFields>
    // CHECK: %[[VAR3:.*]] = kgen.call @S::@__del__(%[[VAR2]]) : (!kgen.pointer<@S> owned_in_mem) -> !kgen.none
    // CHECK: %[[VAR4:.*]] = lit.struct.gep %self[uninitialized] : <@S> from <@HasMemFields>
    // CHECK: %[[VAR5:.*]] = kgen.call @S::@__del__(%[[VAR4]]) : (!kgen.pointer<@S> owned_in_mem) -> !kgen.none
    // CHECK-NOT: kgen.call @HasMemFields::@__del__(%self) : (!kgen.pointer<@HasMemFields> owned_in_mem) -> !kgen.none
...
lit.func @nestedLocalValueThatNeedsDestruct(%cond1: i1, %cond2: i1) -> !kgen.none {
  ...
  hlcf.if %cond1 {
    ...
    %3 = kgen.call @MyStruct::@__init__(%ptr) : (!kgen.pointer<@MyStruct> init_self) -> !kgen.none
    // CHECK: kgen.call @use(
    %6 = kgen.call @use(%ptr) : (!kgen.pointer<@MyStruct> borrow_in_mem) -> !kgen.none
...
lit.func @init(%self: !kgen.pointer<@MyStruct> init_self) {
  ...
  // CHECK-NOT: __del__
  %2 = kgen.call @bar(%self) : (!kgen.pointer<@MyStruct> init_self) -> !kgen.none loc(#loc)
  kgen.return loc(#loc)
} loc(#loc)
...
lit.func @eatErrorNoRef() {
  lit.try {
    %3 = kgen.call @i_raise() : !lit.signature<() throws -> !kgen.variant<!Error, index>>
    ...
    // CHECK: except
    // CHECK-NEXT: %0 = kgen.call @Error::@__del__(%arg0) : (!kgen.declref<@Error>) -> !kgen.none
    // CHECK-NEXT: lit.try.yield
    lit.try.yield
  } else {
    lit.try.yield
...
lit.func @eatErrorRef() {
  lit.try {
    ...
    // CHECK-NEXT: kgen.call @Error::@__del__(%arg0) : (!kgen.declref<@Error>) -> !kgen.none
    kgen.call @doSomething(%arg0) : !lit.signature<("e": !Error borrow) -> !kgen.none>
    lit.try.yield
  } else {
    lit.try.yield
  }
