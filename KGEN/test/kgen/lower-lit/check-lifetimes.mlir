  ...
  destructor = #kgen.symbol.constant<@Struct::@__del__> : !lit.signature<[1](!lit.ref<@Struct, mut *[0,0]> owned_in_mem) -> !kgen.none>}
{
  ...
  //     self.a = 1
  lit.func @__init__[mut selflife](%self: !lit.ref<@Struct, mut selflife> init_self) -> !kgen.none attributes {sourceName = "__init__", specialFnKind = 2 : i8} {
  ...
  lit.func @__copyinit__[mut selflife, imm existinglife](
      ...
      attributes {sourceName = "__copyinit__", specialFnKind = 3 : i8}
      {
