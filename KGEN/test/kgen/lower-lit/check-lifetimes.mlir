...
// CHECK-LABEL: @switch
lit.func @switch(%arg0: index,
                  %A: !lit.ref<@S, mut #lit.lifetime> owned_in_mem,
                  %B: !lit.ref<@S, mut #lit.lifetime> owned_in_mem) -> !kgen.none {
...
lit.func @destroyField(%s2: i1 borrow, %A: !lit.ref<@HasMemFields, mut #lit.lifetime> owned_in_mem) -> !kgen.none {
  // CHECK:  hlcf.elif {
...
lit.struct.decl @GGUFFile
  ...
  lit.func @__init__[mut *"self`2x", imm *"model_path`2x1", mut *"__error__`2x2", mut *"$RANGE`2x5"](
    ...
    hlcf.loop "_loop_0" {
      %9 = lit.call @my_iter::@__len__[mut *"$RANGE`2x5"](%iter) : !lit.signature<[1]("self": !lit.ref<!iter, mut *[0,0]> byref) -> index>
      ...
      %12 = lit.call @my_iter::@__next__[mut *"$RANGE`2x5"](%iter) : !lit.signature<[1]("self": !lit.ref<!iter, mut *[0,0]> byref) -> !Int>
      ...
      %15 = lit.call @Int::@__iadd__[mut *"self`2x"](%13, %14) : !lit.signature<[1]("self": !lit.ref<!Int, mut *[0,0]> byref, "rhs": !Int borrow) -> !kgen.none>
      hlcf.continue
    }
...
lit.struct.decl @GGUFFile
 destructor :!lit.signature<[1]("self": !lit.ref<!GGUFFile, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @GGUFFile::@__del__{
  ...
  lit.func @"__init__"[mut selfLife, mut consumeMeLife, mut iterLife, mut errorLife](
    ...
    %iter: !lit.ref<!iter, mut iterLife> byref,
    %x: i1 borrow,
    %version: !Int borrow, ?,
    %__error__: !lit.ref<!Error, mut errorLife> byref_error) throws -> i1 {
    %15 = kgen.param.constant: i1 = <1>
    hlcf.loop "_loop_0" {
      %10 = lit.call @my_iter::@__len__[mut iterLife](%iter) : !lit.signature<[1]("self": !lit.ref<!iter, mut *[0,0]> byref) -> index>
      %idx0 = index.constant 0
      ...
      %13 = lit.call @my_iter::@"__next__"[mut iterLife](%iter) : !lit.signature<[1]("self": !lit.ref<!iter, mut *[0,0]> byref) -> !Int>

      // CHECK-NEXT: hlcf.elif {
      // CHECK-NEXT:   lit.call @print[mut consumeMeLife](%consumeMe) : !lit.signature<[1](!lit.ref<@GGUFFile, mut *[0,0]> borrow, |) -> !kgen.none>
      ...
      hlcf.elif {
        ...
        %3 = lit.call @print[mut consumeMeLife](%consumeMe) : !lit.signature<[1](!lit.ref<!GGUFFile, mut *[0,0]> borrow, |) -> !kgen.none>
...
// COM: Do Not Propagate Error State Into Continue Set
...
!Dim = !lit.declref<@Dim>
lit.struct.decl @Dim
   destructor :!lit.signature<[1]("self": !lit.ref<!Dim, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @Dim::@__del__{
   lit.struct.field dim : !Int
}
!List = !lit.declref<@List>
lit.struct.decl @List {

}

!Foo = !lit.declref<@Foo>
lit.struct.decl @Foo
  destructor :!lit.signature<[1]("self": !lit.ref<!Foo, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @Foo::@"__del__" {
  lit.struct.field dims : !lit.declref<@List>
  // CHECK-LABEL: lit.func @__init__
  lit.func @__init__[mut selfLife, mut inDimLife, mut errorLife](
    %self: !lit.ref<!Foo, mut selfLife> init_self, |,
    %cond: i1 borrow,
    %i: !Int borrow,
    %dims: !lit.ref<!List, mut inDimLife> owned_in_mem,
    %__error__: !lit.ref<!Error, mut errorLife> byref_error) throws -> i1 {
    ...
    hlcf.loop "_loop_0" {
      ...
      %anonymous2A_1 = lit.var.decl "anonymous*" synth : !lit.ref<!Dim, mut localLife>
      %20 = lit.call @replica::@Dim::@"static"[mut errorLife, mut localLife](%__error__, %anonymous2A_1) : !lit.signature<[2]("__error__": !lit.ref<!Error, mut *[0,0]> byref_error, "__result__": !lit.ref<!Dim, mut *[0,1]> byref_result) throws -> i1>
      hlcf.if %20 {
        lit.ownership.mark_initialized %__error__ : <!Error, mut errorLife>
        %22 = kgen.param.constant: i1 = <1>
        lit.error_return %22 : i1
      } else {
        lit.ownership.mark_initialized %anonymous2A_1 : <!Dim, mut localLife>
        hlcf.yield
      }
        %21 = lit.call @List::@"append"[mut inDimLife, mut localLife](%dims, %anonymous2A_1) : !lit.signature<[2]("self": !lit.ref<@List, mut *[0,0]> byref, "value": !lit.ref<!Dim, mut *[0,1]> owned_in_mem) -> !kgen.none>
        hlcf.continue
      }
      %8 = lit.call @Foo::@__init__[mut selfLife, mut inDimLife](%self, %dims) : !lit.signature<[2](!lit.ref<!Foo, mut *[0,0]> init_self, |, "dims": !lit.ref<@List, mut *[0,1]> owned_in_mem) -> !kgen.none>
      %9 = kgen.param.constant: i1 = <0>
      kgen.return %9 : i1
    }
}
...
// COM: Verify that if a constructor is called within a throwing constructor, the initialized fields are destroyed.

!String = !lit.declref<@String>
lit.struct.decl @String
  destructor :!lit.signature<[1]("self": !lit.ref<!String, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @String::@"__del__" {
  lit.struct.field value : index
}
...
lit.struct.decl @Foo
  destructor :!lit.signature<[1]("self": !lit.ref<!Foo, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @Foo::@"__del__" {
  lit.struct.field str : !String
  // CHECK-LABEL: lit.func @__init__0
  lit.func @__init__0[mut selfLife, mut errorLife](%self: !lit.ref<!Foo, mut selfLife> init_self, |, %cond: i1 borrow, ?, %__error__: !lit.ref<!Error, mut errorLife> byref_error) throws -> i1 {
    %3 = lit.call @Foo::@__init__[mut selfLife](%self) : !lit.signature<[1]("self": !lit.ref<!Foo, mut *[0,0]> init_self) -> !kgen.none>
    // CHECK:      hlcf.elif {
    // CHECK-NEXT:   hlcf.elif.yield %cond : i1
    // CHECK-NEXT: } then {
...
// COM: Destroy Whole Values If Last Reference Was In Loop

!Error = !lit.declref<@Error>
!Int = !lit.declref<@Int>
!TType = !lit.declref<@TType>
!List = !lit.declref<@List>
!Dim = !lit.declref<@Dim>
...
lit.struct.decl @TType
  destructor :!lit.signature<[1]("self": !lit.ref<!TType, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @TType::@__del__ {
  lit.struct.field dims : !List
}
lit.struct.decl @List
  destructor :!lit.signature<[1]("self": !lit.ref<!List, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @List::@__del__ {
  lit.struct.field start : !Int
}
// CHECK-LABEL: lit.func @squeeze
lit.func @squeeze[mut vLife,
                  mut typeLife,
                  mut errorLife](%cond: i1 borrow,
                                 %i: !Int borrow,
                                 %v_type: !lit.ref<!TType, mut typeLife> owned_in_mem, ?,
                                 %__error__: !lit.ref<!Error, mut errorLife> byref_error) throws -> i1 {
  hlcf.loop "_loop_0" {
    // CHECK: hlcf.if
    // CHECK-NEXT: hlcf.yield
    // CHECK-NEXT: } else {
    // CHECK-NEXT: lit.call @TType::@__del__[mut typeLife](%v_type)
    // CHECK-NEXT: hlcf.break "_loop_0"
    // CHECK-NEXT: }
    hlcf.if %cond {
      hlcf.yield
    ...
    hlcf.elif {
      ...
      %14 = lit.ref.struct.ger %v_type[dims] : <@List, mut typeLife> from !TType
      %20 = lit.call @print[mut typeLife](%14) : !lit.signature<[1]("x" : !lit.ref<@List, mut *[0,0]> borrow_in_mem) -> !kgen.none>
      hlcf.yield
    } else {
      hlcf.yield
    }
...
// COM: Destroy Before Overwrite In Conditional Initialization

!FileHandle = !lit.declref<@FileHandle>
lit.struct.decl @FileHandle
  destructor :!lit.signature<[1]("self": !lit.ref<!FileHandle, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @FileHandle::@__del__{
  lit.struct.field str : index
}
...
!FileManager = !lit.declref<@FileManager>
lit.struct.decl @FileManager
  destructor :!lit.signature<[1]("self": !lit.ref<!FileManager, mut *[0,0]> owned_in_mem, |) -> !kgen.none> @FileManager::@__del__{
  lit.struct.field fh : !FileHandle
  lit.func @open[mut selfLife](%self: !lit.ref<!FileManager, mut selfLife> byref) -> !kgen.none {
    // CHECK:       %0 = lit.ref.struct.ger %self[fh] : <@FileHandle, mut selfLife> from @FileManager
    // CHECK-NEXT:  %1 = lit.call @FileHandle::@__del__[mut selfLife](%0) : !lit.signature<[1]("self": !lit.ref<@FileHandle, mut *[0,0]> owned_in_mem, |) -> !kgen.none>
    // CHECK-NEXT:  %__try_error__ = lit.var.decl "__try_error__" synth : !lit.ref<@Error, mut errorLife>
    // CHECK-NEXT:  lit.try {
    // CHECK-NEXT:    %2 = lit.ref.struct.ger %self[fh] : <@FileHandle, mut selfLife> from @FileManager
    // CHECK-NEXT:    %3 = lit.call @file::@open[mut errorLife, mut selfLife](%__try_error__, %2) : !lit.signature<[2]("__error__": !lit.ref<@Error, mut *[0,0]> byref_error, "__result__": !lit.ref<@FileHandle, mut *[0,1]> byref_result) throws -> i1>
    // CHECK-NEXT:    hlcf.if %3 {
    // CHECK-NEXT:      lit.ownership.mark_initialized %__try_error__ : <@Error, mut errorLife>
    // CHECK-NEXT:      %4 = lit.ref.load %__try_error__ : <@Error, mut errorLife>
    // CHECK-NEXT:      %5 = lit.call @Error::@__del__(%4) : !lit.signature<("self": !lit.declref<@Error>, |) -> !kgen.none>
    // CHECK-NEXT:      lit.try.raise
    // CHECK-NEXT:    } else {
    // CHECK-NEXT:      lit.ownership.mark_initialized %2 : <@FileHandle, mut selfLife>
    // CHECK-NEXT:      hlcf.yield
    // CHECK-NEXT:    }
    ...
    // CHECK-NEXT:      lit.try.yield
    // CHECK-NEXT:    }
    %__try_error__ = lit.var.decl "__try_error__" synth : !lit.ref<!Error, mut errorLife>
    lit.try {
      %3 = lit.ref.struct.ger %self[fh] : <!FileHandle, mut selfLife> from !FileManager
      %4 = lit.call @file::@open[mut errorLife, mut selfLife](%__try_error__, %3) : !lit.signature<[2]("__error__": !lit.ref<!Error, mut *[0,0]> byref_error, "__result__": !lit.ref<!FileHandle, mut *[0,1]> byref_result) throws -> i1>
      hlcf.if %4 {
        lit.ownership.mark_initialized %__try_error__ : <!Error, mut errorLife>
        lit.try.raise
      } else {
        lit.ownership.mark_initialized %3 : <!FileHandle, mut selfLife>
        hlcf.yield
      }
      lit.try.yield
    } except {
