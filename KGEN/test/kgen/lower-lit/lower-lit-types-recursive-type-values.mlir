...
// CHECK: kgen.struct.generator @ListNode = [struct_inst<"ListNode"(next: pointer<typevalue<inst_struct_ref(#kgen.typeref<@ListNode>)>>) memoryOnly>, struct<(pointer<none>) memoryOnly>]
...
// CHECK: kgen.struct.generator @Bar = [struct_inst<"Bar"(foo: typevalue<inst_struct_ref(#kgen.typeref<@Foo>)>)>, pointer<none>]
lit.struct.decl @Bar register_passable {
  lit.struct.field foo: !lit.struct<@Foo>
}

// CHECK: kgen.struct.generator @Foo = [struct_inst<"Foo"(bar_ptr: pointer<typevalue<inst_struct_ref(#kgen.typeref<@Bar>)>>)>, pointer<none>]
...
// CHECK: kgen.struct.generator @ListNode = [struct_inst<"ListNode"(next: typevalue<inst_struct_ref(#kgen.typeref<@Pointer<:type [typevalue<inst_struct_ref(#kgen.typeref<@ListNode>)>, struct<(pointer<none>) memoryOnly>]>>)>) memoryOnly>, struct<(pointer<none>) memoryOnly>]
lit.struct.decl @ListNode {
  lit.struct.field next : !lit.struct<@Pointer<:type !lit.struct<@ListNode>>>
}

// CHECK: kgen.struct.generator @Pointer<ty: type> = [struct_inst<"Pointer"[ty]<:type ty>(address: pointer<typevalue<ty>>)>, pointer<none>]
