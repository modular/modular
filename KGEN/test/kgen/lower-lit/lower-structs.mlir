...
!kgen.pointer<@Pointer<:regtype !foo_ref>> {
  ...
  %0 = lit.struct.gep %s[x] : <@Pointer<:regtype !foo_ref>> from <@Bar>
  kgen.return %0 : !kgen.pointer<@Pointer<:regtype !foo_ref>>
}
