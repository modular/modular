...
kgen.func @cse_intrinsic() -> !pop.scalar<f32> {
    // CHECK-COUNT-1: pop.call_llvm_intrinsic side_effecting false "no_side_effect_intrinsic", ()
    %0 = pop.call_llvm_intrinsic side_effecting false "no_side_effect_intrinsic", () : () -> !pop.scalar<f32>
    %1 = pop.call_llvm_intrinsic side_effecting false "no_side_effect_intrinsic", () : () -> !pop.scalar<f32>
