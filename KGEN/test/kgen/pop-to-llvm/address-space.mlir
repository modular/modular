...
module attributes {M.target_info = #M.target<triple="", arch="", features="", data_layout="", simd_bit_width=128>} {
  ...
  kgen.func @global_load() -> !pop.scalar<f32> {
    ...
    // CHECK-NEXT: %3 = llvm.addrspacecast %1 : !llvm.ptr<3> to !llvm.ptr
    // CHECK-NEXT: %4 = llvm.load %3 {alignment = 4 : i64} : !llvm.ptr
...
module attributes {M.target_info = #M.target<triple="", arch="", features="", data_layout="", simd_bit_width=128>} {
  ...
  kgen.func @global_store(%arg0: !pop.scalar<f32>) {
    ...
    // CHECK-NEXT: %4 = llvm.addrspacecast %2 : !llvm.ptr<3> to !llvm.ptr
    // CHECK-NEXT: llvm.store %0, %4 {alignment = 4 : i64} : f32, !llvm.ptr
    %0 = pop.global_alloc 2 x !pop.scalar<f32> address_space 3 align 4
