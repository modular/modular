...
module attributes {M.target_info = #M.target<triple="", arch="", features="", data_layout="", simd_bit_width=128>} {
  ...
  kgen.func @global_load() -> !pop.scalar<f32> {
    ...
    // CHECK-NEXT: %2 = llvm.load %1 {alignment = 4 : i64} : !llvm.ptr<3> -> f32 
    // CHECK-NEXT: %3 = builtin.unrealized_conversion_cast %2 : f32 to !pop.scalar<f32>
    %0 = pop.global_alloc "my_global" 2 x !pop.scalar<f32> address_space 3 align 4
