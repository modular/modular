...
module attributes {M.target_info = #M.target<triple = "amdgcn-amd-amdhsa", arch="gfx942", data_layout="">} {
  ...
  kgen.func @scalar_cast_f32_bf16(%f32: !kgen.scalar<f32>) -> (!kgen.scalar<bf16>, !kgen.scalar<bf16>) {
    ...
    %0 = pop.cast fast %f32 : !kgen.scalar<f32> to !kgen.scalar<bf16>
    // CHECK-NEXT: llvm.fptrunc %{{.*}} : f32 to bf16
    %1 = pop.cast %f32 : !kgen.scalar<f32> to !kgen.scalar<bf16>
    kgen.return %0, %1 :
      !kgen.scalar<bf16>,
      !kgen.scalar<bf16>
  }
  ...
  kgen.func @simd_cast_f32_bf16(%f32: !kgen.simd<2, f32>) -> (!kgen.simd<2, bf16>, !kgen.simd<2, bf16>) {
    ...
    %0 = pop.cast fast %f32 : !kgen.simd<2, f32> to !kgen.simd<2, bf16>
    // CHECK: llvm.fptrunc %arg0 : vector<2xf32> to vector<2xbf16>
    %1 = pop.cast %f32 : !kgen.simd<2, f32> to !kgen.simd<2, bf16>
    kgen.return %0, %1 :
      !kgen.simd<2, bf16>,
      !kgen.simd<2, bf16>
  }
  ...
  kgen.func @scalar_cast_f32_f8(%f32: !kgen.scalar<f32>) -> (!kgen.scalar<f8e4m3fnuz>, !kgen.scalar<f8e5m2fnuz>) {
    ...
    %0 = pop.cast %f32 : !kgen.scalar<f32> to !kgen.scalar<f8e4m3fnuz>
    ...
    %1 = pop.cast %f32 : !kgen.scalar<f32> to !kgen.scalar<f8e5m2fnuz>

    kgen.return %0, %1 :
      !kgen.scalar<f8e4m3fnuz>,
      !kgen.scalar<f8e5m2fnuz>
  }

  // CHECK-LABEL: simd2_cast_f32_f8
  kgen.func @simd2_cast_f32_f8(%f32: !kgen.simd<2, f32>) -> (!kgen.simd<2, f8e4m3fnuz>, !kgen.simd<2, f8e5m2fnuz>) {
    ...
    %0 = pop.cast %f32 : !kgen.simd<2, f32> to !kgen.simd<2, f8e4m3fnuz>
    ...
    %1 = pop.cast %f32 : !kgen.simd<2, f32> to !kgen.simd<2, f8e5m2fnuz>

    kgen.return %0, %1 :
      !kgen.simd<2, f8e4m3fnuz>,
      !kgen.simd<2, f8e5m2fnuz>
  }

  // CHECK-LABEL: simd4_cast_f32_f8
  kgen.func @simd4_cast_f32_f8(%f32: !kgen.simd<4, f32>) -> (!kgen.simd<4, f8e4m3fnuz>, !kgen.simd<4, f8e5m2fnuz>) {
    ...
    %0 = pop.cast %f32 : !kgen.simd<4, f32> to !kgen.simd<4, f8e4m3fnuz>
    ...
    %1 = pop.cast %f32 : !kgen.simd<4, f32> to !kgen.simd<4, f8e5m2fnuz>

    kgen.return %0, %1 :
      !kgen.simd<4, f8e4m3fnuz>,
      !kgen.simd<4, f8e5m2fnuz>
  }

  // CHECK-LABEL: scalar_cast_f8_f32
  kgen.func @scalar_cast_f8_f32(%f8: !kgen.scalar<f8e4m3fnuz>) -> !kgen.scalar<f32> {
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    ...
    %0 = pop.cast %f8: !kgen.scalar<f8e4m3fnuz> to !kgen.scalar<f32>
    kgen.return %0 : !kgen.scalar<f32>
  }

  // CHECK-LABEL: simd2_cast_f8_f32
  kgen.func @simd2_cast_f8_f32(%f8: !kgen.simd<2, f8e4m3fnuz>) -> !kgen.simd<2, f32> {
    // CHECK-DAG: %[[FALSE:.+]] = llvm.mlir.constant(false) : i1
    // CHECK-DAG: %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    ...
    %0 = pop.cast %f8 : !kgen.simd<2, f8e4m3fnuz> to !kgen.simd<2, f32>
    kgen.return %0 : !kgen.simd<2, f32>
  }

  // CHECK-LABEL: simd4_cast_f8_f32
  kgen.func @simd4_cast_f8_f32(%f8: !kgen.simd<4, f8e4m3fnuz>) -> !kgen.simd<4, f32> {
    // CHECK-DAG: %[[TRUE:.+]] = llvm.mlir.constant(true) : i1
    // CHECK-DAG: %[[FALSE:.+]] = llvm.mlir.constant(false) : i1
    // CHECK-DAG: %[[THREE:.+]] = llvm.mlir.constant(3 : i32) : i32
    // CHECK-DAG: %[[TWO:.+]] = llvm.mlir.constant(2 : i32) : i32
    ...
    %0 = pop.cast %f8 : !kgen.simd<4, f8e4m3fnuz> to !kgen.simd<4, f32>
...
module attributes {M.target_info = #M.target<triple = "nvptx-nvidia-cuda", arch="sm_90", data_layout="">} {
  ...
  kgen.func @simd_cast_f32_to_f8(%f32: !kgen.simd<4, f32>) -> (!kgen.simd<4, f8e4m3fn>, !kgen.simd<4, f8e5m2>) {
    // CHECK-DAG:    %[[TWO:.+]] = llvm.mlir.constant(2 : i32) : i32
    // CHECK-DAG:    %[[THREE:.+]] = llvm.mlir.constant(3 : i32) : i32
    // CHECK-DAG:    %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG:    %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    ...
    %0 = pop.cast %f32 : !kgen.simd<4, f32> to !kgen.simd<4, f8e4m3fn>
    ...
    %1 = pop.cast %f32 : !kgen.simd<4, f32> to !kgen.simd<4, f8e5m2>
    kgen.return %0, %1: !kgen.simd<4, f8e4m3fn>, !kgen.simd<4, f8e5m2>
  }

  // CHECK-LABEL: simd_cast_f8_to_f16
  kgen.func @simd_cast_f8_to_f16(%f8e4: !kgen.simd<4, f8e4m3fn>, %f8e5: !kgen.simd<4, f8e5m2>) -> (!kgen.simd<4, f16>, !kgen.simd<4, f16>) {
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG: %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    ...
    %0 = pop.cast %f8e4 : !kgen.simd<4, f8e4m3fn> to !kgen.simd<4, f16>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<4, f8e5m2> to !kgen.simd<4, f16>
    kgen.return %0, %1: !kgen.simd<4, f16>, !kgen.simd<4, f16>
  }

  // CHECK-LABEL: simd_cast_f8_to_f32
  kgen.func @simd_cast_f8_to_f32(%f8e4: !kgen.simd<4, f8e4m3fn>, %f8e5: !kgen.simd<4, f8e5m2>) -> (!kgen.simd<4, f32>, !kgen.simd<4, f32>) {
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG: %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    // CHECK-DAG: %[[UNDEF_I32:.+]] = llvm.mlir.undef : vector<2xi32>
    // CHECK-NEXT: %[[ARG0_I16:.+]] = llvm.bitcast %arg0 : vector<4xi8> to vector<2xi16>
    ...
    %0 = pop.cast %f8e4 : !kgen.simd<4, f8e4m3fn> to !kgen.simd<4, f32>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<4, f8e5m2> to !kgen.simd<4, f32>
    kgen.return %0, %1: !kgen.simd<4, f32>, !kgen.simd<4, f32>
  }

  // CHECK-LABEL: scalar_cast_f8_to_f16
  kgen.func @scalar_cast_f8_to_f16(%f8e4: !kgen.simd<1, f8e4m3fn>, %f8e5: !kgen.simd<1, f8e5m2>) -> (!kgen.simd<1, f16>, !kgen.simd<1, f16>) {
    ...
    %0 = pop.cast %f8e4 : !kgen.simd<1, f8e4m3fn> to !kgen.simd<1, f16>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<1, f8e5m2> to !kgen.simd<1, f16>
    kgen.return %0, %1: !kgen.simd<1, f16>, !kgen.simd<1, f16>
  }

  // CHECK-LABEL: scalar_cast_f8_to_f32
  kgen.func @scalar_cast_f8_to_f32(%f8e4: !kgen.simd<1, f8e4m3fn>, %f8e5: !kgen.simd<1, f8e5m2>) -> (!kgen.simd<1, f32>, !kgen.simd<1, f32>) {
    // CHECK: %[[ARG0_I16:.+]] = llvm.zext %arg0 : i8 to i16
    // CHECK-NEXT: %[[ARG0_I32:.+]] = llvm.inline_asm asm_dialect = att "cvt.rn.f16x2.e4m3x2 $0, $1;", "=r,h" %[[ARG0_I16]] : (i16) -> i32
    // CHECK-NEXT: %[[ARG0_I16:.+]] = llvm.trunc %[[ARG0_I32]] : i32 to i16
    // CHECK-NEXT: %[[ARG0_F16:.+]] = llvm.bitcast %[[ARG0_I16]] : i16 to f16
    // CHECK-NEXT: %[[RES0_F32:.+]] = llvm.fpext %[[ARG0_F16]] : f16 to f32
    %0 = pop.cast %f8e4 : !kgen.simd<1, f8e4m3fn> to !kgen.simd<1, f32>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<1, f8e5m2> to !kgen.simd<1, f32>
    kgen.return %0, %1: !kgen.simd<1, f32>, !kgen.simd<1, f32>
  }

  // CHECK-LABEL: scalar_cast_f32_to_f8
  kgen.func @scalar_cast_f32_to_f8(%f32: !kgen.simd<1, f32>) -> (!kgen.simd<1, f8e4m3fn>, !kgen.simd<1, f8e5m2>) {
    ...
    %0 = pop.cast %f32 : !kgen.simd<1, f32> to !kgen.simd<1, f8e4m3fn>
    ...
    %1 = pop.cast %f32 : !kgen.simd<1, f32> to !kgen.simd<1, f8e5m2>
    kgen.return %0, %1: !kgen.simd<1, f8e4m3fn>, !kgen.simd<1, f8e5m2>
  }

  // CHECK-LABEL: simd_cast_f8_to_bf16
  kgen.func @simd_cast_f8_to_bf16(%f8e4: !kgen.simd<4, f8e4m3fn>, %f8e5: !kgen.simd<4, f8e5m2>) -> (!kgen.simd<4, bf16>, !kgen.simd<4, bf16>) {
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG: %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    // CHECK-DAG: %[[UNDEF_I32:.+]] = llvm.mlir.undef : vector<2xi32>
    // CHECK-NEXT: %[[ARG0_I16:.+]] = llvm.bitcast %arg0 : vector<4xi8> to vector<2xi16>
    ...
    %0 = pop.cast %f8e4 : !kgen.simd<4, f8e4m3fn> to !kgen.simd<4, bf16>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<4, f8e5m2> to !kgen.simd<4, bf16>
    kgen.return %0, %1: !kgen.simd<4, bf16>, !kgen.simd<4, bf16>
  }

  // CHECK-LABEL: scalar_cast_f8_to_bf16
  kgen.func @scalar_cast_f8_to_bf16(%f8e4: !kgen.simd<1, f8e4m3fn>, %f8e5: !kgen.simd<1, f8e5m2>) -> (!kgen.simd<1, bf16>, !kgen.simd<1, bf16>) {
    // CHECK: %[[ARG0_I16:.+]] = llvm.zext %arg0 : i8 to i16
    // CHECK-NEXT: %[[ARG0_I32:.+]] = llvm.inline_asm asm_dialect = att "cvt.rn.f16x2.e4m3x2 $0, $1;", "=r,h" %[[ARG0_I16]] : (i16) -> i32
    // CHECK-NEXT: %[[ARG0_I16:.+]] = llvm.trunc %[[ARG0_I32]] : i32 to i16
    // CHECK-NEXT: %[[ARG0_F16:.+]] = llvm.bitcast %[[ARG0_I16]] : i16 to f16
    ...
    %0 = pop.cast %f8e4 : !kgen.simd<1, f8e4m3fn> to !kgen.simd<1, bf16>
    ...
    %1 = pop.cast %f8e5  : !kgen.simd<1, f8e5m2> to !kgen.simd<1, bf16>
    kgen.return %0, %1: !kgen.simd<1, bf16>, !kgen.simd<1, bf16>
  }

  // CHECK-LABEL: simd_cast_bf16_to_f8
  kgen.func @simd_cast_bf16_to_f8(%bf16: !kgen.simd<4, bf16>) -> (!kgen.simd<4, f8e4m3fn>, !kgen.simd<4, f8e5m2>) {
    // CHECK-DAG:    %[[TWO:.+]] = llvm.mlir.constant(2 : i32) : i32
    // CHECK-DAG:    %[[THREE:.+]] = llvm.mlir.constant(3 : i32) : i32
    // CHECK-DAG:    %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG:    %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    ...
    // CHECK-DAG:    %[[VEC_F8E4_RES_0123:.+]] = llvm.insertelement %[[VEC_F8E4_RES_23]], %[[VEC_F8E4_RES_01]][%[[ONE]] : i32] : vector<2xi16>
    // CHECK-DAG:    %[[VEC_F8E4_RES:.+]] = llvm.bitcast %[[VEC_F8E4_RES_0123]] : vector<2xi16> to vector<4xi8>
    %0 = pop.cast %bf16 : !kgen.simd<4, bf16> to !kgen.simd<4, f8e4m3fn>
    ...
    // CHECK-DAG:    %[[VEC_F8E5_RES_0123:.+]] = llvm.insertelement %[[VEC_F8E5_RES_23]], %[[VEC_F8E5_RES_01]][%[[ONE]] : i32] : vector<2xi16>
    // CHECK-DAG:    %[[VEC_F8E5_RES:.+]] = llvm.bitcast %[[VEC_F8E5_RES_0123]] : vector<2xi16> to vector<4xi8>
    %1 = pop.cast %bf16 : !kgen.simd<4, bf16> to !kgen.simd<4, f8e5m2>
    kgen.return %0, %1: !kgen.simd<4, f8e4m3fn>, !kgen.simd<4, f8e5m2>
  }

  // CHECK-LABEL: scalar_cast_bf16_to_f8
  kgen.func @scalar_cast_bf16_to_f8(%bf16: !kgen.simd<1, bf16>) -> (!kgen.simd<1, f8e4m3fn>, !kgen.simd<1, f8e5m2>) {
    // CHECK-DAG:    %[[FP32_ZERO:.+]] = llvm.mlir.constant(0.000000e+00 : f32) : f3
    ...
    // CHECK-DAG:    %[[VEC_F8E4_RES:.+]] = llvm.trunc %[[I16_RES0]] : i16 to i8
    %0 = pop.cast %bf16 : !kgen.simd<1, bf16> to !kgen.simd<1, f8e4m3fn>
    ...
    // CHECK-DAG:    %[[VEC_F8E5_RES:.+]] = llvm.trunc %[[I16_RES1]] : i16 to i8
    %1 = pop.cast %bf16 : !kgen.simd<1, bf16> to !kgen.simd<1, f8e5m2>
    kgen.return %0, %1: !kgen.simd<1, f8e4m3fn>, !kgen.simd<1, f8e5m2>
  }
}
...
module attributes {M.target_info = #M.target<triple = "amdgcn-amd-amdhsa", arch="gfx950", data_layout="">} {
  ...
  kgen.func @simd_cast_f8_to_bf16_amd(%f8e4: !kgen.simd<4, f8e4m3fn>, %f8e5: !kgen.simd<4, f8e5m2>) -> (!kgen.simd<4, bf16>, !kgen.simd<4, bf16>) {
  ...
  kgen.func @simd_cast_f8uz_to_bf16_amd(%f8e4: !kgen.simd<4, f8e4m3fnuz>, %f8e5: !kgen.simd<4, f8e5m2fnuz>) -> (!kgen.simd<4, bf16>, !kgen.simd<4, bf16>) {
    // For e4m3fn: First convert FP8 -> F32 using AMD intrinsics
    // CHECK-DAG: %[[ZERO:.+]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-DAG: %[[ONE:.+]] = llvm.mlir.constant(1 : i32) : i32
    // CHECK-DAG: %[[FALSE:.+]] = llvm.mlir.constant(false) : i1
    ...
    // Then convert F32 to BF16 using fptrunc
    // CHECK: llvm.fptrunc {{.*}} : vector<4xf32> to vector<4xbf16>
    %0 = pop.cast %f8e4 : !kgen.simd<4, f8e4m3fnuz> to !kgen.simd<4, bf16>

    // For e5m2: First convert FP8 -> F32 using AMD intrinsics
    // CHECK: llvm.call_intrinsic "llvm.amdgcn.cvt.pk.f32.bf8"
    // Then convert F32 to BF16 using fptrunc
    // CHECK: llvm.fptrunc {{.*}} : vector<4xf32> to vector<4xbf16>
    %1 = pop.cast %f8e5 : !kgen.simd<4, f8e5m2fnuz> to !kgen.simd<4, bf16>
...
module attributes {M.target_info = #M.target<triple = "air64-apple-macosx", arch = "", data_layout = "", simd_bit_width = 128>} {
  ...
  kgen.func @test_pop_cast_no_air(
    ...
    !kgen.scalar<bf16>, !kgen.scalar<f32>,
    !kgen.scalar<si16>, !kgen.scalar<ui16>, !kgen.scalar<si32>, !kgen.scalar<ui32>,
    !kgen.scalar<si8>, !kgen.scalar<ui8>, !kgen.scalar<si32>, !kgen.scalar<ui32>,
    !kgen.scalar<si8>, !kgen.scalar<ui8>, !kgen.scalar<si32>, !kgen.scalar<ui32>,
    !kgen.scalar<si8>, !kgen.scalar<ui8>, !kgen.scalar<si16>, !kgen.scalar<ui16>,
    !kgen.scalar<si8>, !kgen.scalar<ui8>, !kgen.scalar<si16>, !kgen.scalar<ui16>,
    !kgen.scalar<f32>,
    !kgen.scalar<f32>,
    !kgen.scalar<f16>, !kgen.scalar<bf16>
  ){
    // ========================================================================
    // from si8
    // ========================================================================
    // CHECK: %[[UNREALIZED_CONVERSION_CAST_0:.*]] = builtin.unrealized_conversion_cast %arg0 : i8 to !kgen.scalar<si8>
    // CHECK: %[[CAST_0:.*]] = pop.cast %[[UNREALIZED_CONVERSION_CAST_0]] : !kgen.scalar<si8> to !kgen.scalar<bf16>
    %si8_to_bf16 = pop.cast %si8_val : !kgen.scalar<si8> to !kgen.scalar<bf16>

    // CHECK: %[[UNREALIZED_CONVERSION_CAST_1:.*]] = builtin.unrealized_conversion_cast %[[CAST_0]] : !kgen.scalar<bf16> to bf16
    // CHECK: %[[CAST_1:.*]] = pop.cast %[[UNREALIZED_CONVERSION_CAST_0]] : !kgen.scalar<si8> to !kgen.scalar<f32>
    ...
    %ui8_to_si16 = pop.cast %ui8_val : !kgen.scalar<ui8> to !kgen.scalar<si16>

    // CHECK: %[[ZEXT_1:.*]] = llvm.zext %arg1 : i8 to i16
    %ui8_to_ui16 = pop.cast %ui8_val : !kgen.scalar<ui8> to !kgen.scalar<ui16>

    // CHECK: %[[ZEXT_2:.*]] = llvm.zext %arg1 : i8 to i32
    %ui8_to_si32 = pop.cast %ui8_val : !kgen.scalar<ui8> to !kgen.scalar<si32>

    // CHECK: %[[ZEXT_3:.*]] = llvm.zext %arg1 : i8 to i32
    %ui8_to_ui32 = pop.cast %ui8_val : !kgen.scalar<ui8> to !kgen.scalar<ui32>

    // ========================================================================
    // from si16
    // ========================================================================
    // CHECK: %[[TRUNC_0:.*]] = llvm.trunc %arg2 : i16 to i8
    %si16_to_si8 = pop.cast %si16_val : !kgen.scalar<si16> to !kgen.scalar<si8>

    // CHECK: %[[TRUNC_1:.*]] = llvm.trunc %arg2 : i16 to i8
    %si16_to_ui8 = pop.cast %si16_val : !kgen.scalar<si16> to !kgen.scalar<ui8>

    // CHECK: %[[SEXT_0:.*]] = llvm.sext %arg2 : i16 to i32
    %si16_to_si32 = pop.cast %si16_val : !kgen.scalar<si16> to !kgen.scalar<si32>

    // CHECK: %[[SEXT_1:.*]] = llvm.sext %arg2 : i16 to i32
    %si16_to_ui32 = pop.cast %si16_val : !kgen.scalar<si16> to !kgen.scalar<ui32>

    // ========================================================================
    // from ui16
    // ========================================================================
    // CHECK: %[[TRUNC_2:.*]] = llvm.trunc %arg3 : i16 to i8
    %ui16_to_si8 = pop.cast %ui16_val : !kgen.scalar<ui16> to !kgen.scalar<si8>

    // CHECK: %[[TRUNC_3:.*]] = llvm.trunc %arg3 : i16 to i8
    %ui16_to_ui8 = pop.cast %ui16_val : !kgen.scalar<ui16> to !kgen.scalar<ui8>

    // CHECK: %[[ZEXT_4:.*]] = llvm.zext %arg3 : i16 to i32
    %ui16_to_si32 = pop.cast %ui16_val : !kgen.scalar<ui16> to !kgen.scalar<si32>

    // CHECK: %[[ZEXT_5:.*]] = llvm.zext %arg3 : i16 to i32
    %ui16_to_ui32 = pop.cast %ui16_val : !kgen.scalar<ui16> to !kgen.scalar<ui32>

    // ========================================================================
    // from si32
    // ========================================================================
    // CHECK: %[[TRUNC_4:.*]] = llvm.trunc %arg4 : i32 to i8
    %si32_to_si8 = pop.cast %si32_val : !kgen.scalar<si32> to !kgen.scalar<si8>

    // CHECK: %[[TRUNC_5:.*]] = llvm.trunc %arg4 : i32 to i8
    %si32_to_ui8 = pop.cast %si32_val : !kgen.scalar<si32> to !kgen.scalar<ui8>

    // CHECK: %[[TRUNC_6:.*]] = llvm.trunc %arg4 : i32 to i16
    %si32_to_si16 = pop.cast %si32_val : !kgen.scalar<si32> to !kgen.scalar<si16>

    // CHECK: %[[TRUNC_7:.*]] = llvm.trunc %arg4 : i32 to i16
    %si32_to_ui16 = pop.cast %si32_val : !kgen.scalar<si32> to !kgen.scalar<ui16>

    // ========================================================================
    // from ui32
    // ========================================================================
    // CHECK: %[[TRUNC_8:.*]] = llvm.trunc %arg5 : i32 to i8
    %ui32_to_si8 = pop.cast %ui32_val : !kgen.scalar<ui32> to !kgen.scalar<si8>

    // CHECK: %[[TRUNC_9:.*]] = llvm.trunc %arg5 : i32 to i8
    %ui32_to_ui8 = pop.cast %ui32_val : !kgen.scalar<ui32> to !kgen.scalar<ui8>

    // CHECK: %[[TRUNC_10:.*]] = llvm.trunc %arg5 : i32 to i16
    %ui32_to_si16 = pop.cast %ui32_val : !kgen.scalar<ui32> to !kgen.scalar<si16>

    // CHECK: %[[TRUNC_11:.*]] = llvm.trunc %arg5 : i32 to i16
    %ui32_to_ui16 = pop.cast %ui32_val : !kgen.scalar<ui32> to !kgen.scalar<ui16>

    // ========================================================================
    // from f16
    // ========================================================================
    // CHECK: %[[FPEXT_0:.*]] = llvm.fpext %arg6 : f16 to f32
    %f16_to_f32 = pop.cast %f16_val : !kgen.scalar<f16> to !kgen.scalar<f32>

    // ========================================================================
    // from bf16
    // ========================================================================
    // CHECK: %[[FPEXT_1:.*]] = llvm.fpext %arg7 : bf16 to f32
    %bf16_to_f32 = pop.cast %bf16_val : !kgen.scalar<bf16> to !kgen.scalar<f32>

    // ========================================================================
    // from f32
    // ========================================================================
    // CHECK: %[[FPTRUNC_0:.*]] = llvm.fptrunc %arg8 : f32 to f16
    %f32_to_f16 = pop.cast %f32_val : !kgen.scalar<f32> to !kgen.scalar<f16>

    // CHECK: %[[FPTRUNC_1:.*]] = llvm.fptrunc %arg8 : f32 to bf16
    %f32_to_bf16 = pop.cast %f32_val : !kgen.scalar<f32> to !kgen.scalar<bf16>
