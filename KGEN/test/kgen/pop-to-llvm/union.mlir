...
kgen.func @union_create_0(%arg0: i32) -> !pop.union<i32> {
  ...
  // CHECK-NEXT: %[[P0:.*]] = llvm.lshr %arg0, %[[I32_0]]
  // CHECK-NEXT: %[[P1:.*]] = llvm.zext %[[P0]] : i32 to i64
  // CHECK-NEXT: %[[P2:.*]] = llvm.shl %[[P1]], %[[I64_0]]
  // CHECK-NEXT: %[[P3:.*]] = llvm.or %[[I64_0]], %[[P2]]
  // CHECK-NEXT: %[[S1:.*]] = llvm.insertvalue %[[P3]], %[[S0]][0]
...
kgen.func @union_get_3(%arg0: !pop.union<struct<(i32, i64, i32)>, array<4, i64>>) -> !kgen.struct<(i32, i64, i32)> {
  ...
  // CHECK: %[[P5:.*]] = llvm.extractvalue %arg0[0] : !llvm.array<4 x i64>
  // CHECK: %[[P6:.*]] = llvm.extractvalue %arg0[1] : !llvm.array<4 x i64>
...
kgen.func @union_get_4(%arg0: !pop.union<struct<(array<2, i16>, struct<(struct<(i8, i32)>, simd<2, f32>)>)>>) -> !kgen.struct<(array<2, i16>, struct<(struct<(i8, i32)>, simd<2, f32>)>)> {
  ...
  // CHECK: %[[P12:.*]] = llvm.extractvalue %arg0[0] : !llvm.array<3 x i64>
  // CHECK: %[[P13:.*]] = llvm.extractvalue %arg0[1] : !llvm.array<3 x i64>
  // CHECK: %[[P14:.*]] = llvm.extractvalue %arg0[2] : !llvm.array<3 x i64>
...
kgen.func @union_constant_0() -> !pop.union<i32> {
  // CHECK-DAG: [[P8:%.*]] = llvm.mlir.undef : !llvm.array<1 x i64>
  // CHECK-DAG: [[P0:%.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: [[P1:%.*]] = llvm.mlir.constant(0 : i64) : i64
  // CHECK-DAG: [[P2:%.*]] = llvm.mlir.constant(0 : i32) : i32
  // CHECK: [[P3:%.*]] = llvm.lshr [[P0]], [[P2]]  : i32
  // CHECK: [[P4:%.*]] = llvm.zext [[P3]] : i32 to i64
  // CHECK: [[P6:%.*]] = llvm.shl [[P4]], [[P1]]  : i64
  // CHECK: [[P7:%.*]] = llvm.or [[P1]], [[P6]]  : i64
  // CHECK: [[P9:%.*]] = llvm.insertvalue [[P7]], [[P8]][0] : !llvm.array<1 x i64>
  // CHECK: llvm.return [[P9]] : !llvm.array<1 x i64>
...
kgen.func @union_constant_1() -> !pop.union<struct<(i32, i64, i32)>, struct<(f64, f32)>> {
  ...
  // CHECK-DAG: [[P3:%.*]] = llvm.mlir.constant(2 : i64) : i64
  // CHECK-DAG: [[P5:%.*]] = llvm.mlir.constant(3 : i32) : i32
  // CHECK-DAG: [[P7:%.*]] = llvm.mlir.constant(0 : i64) : i64
  // CHECK-DAG: [[P10:%.*]] = llvm.mlir.constant(0 : i32) : i32
  // CHECK-DAG: [[P20:%.*]] = llvm.mlir.constant(32 : i64) : i64
  // CHECK-DAG: [[P36:%.*]] = llvm.mlir.undef : !llvm.array<2 x i64>
  // CHECK: [[P11:%.*]] = llvm.lshr [[P1]], [[P10]]  : i32
  // CHECK: [[P12:%.*]] = llvm.zext [[P11]] : i32 to i64
  // CHECK: [[P14:%.*]] = llvm.shl [[P12]], [[P7]]  : i64
  // CHECK: [[P15:%.*]] = llvm.or [[P7]], [[P14]]  : i64
  // CHECK: [[P18:%.*]] = llvm.lshr [[P3]], [[P7]]  : i64
  // CHECK: [[P19:%.*]] = llvm.trunc [[P18]] : i64 to i64
  // CHECK: [[P21:%.*]] = llvm.shl [[P19]], [[P20]]  : i64
  // CHECK: [[P22:%.*]] = llvm.or [[P15]], [[P21]]  : i64
  // CHECK: [[P24:%.*]] = llvm.lshr [[P3]], [[P20]]  : i64
  // CHECK: [[P25:%.*]] = llvm.trunc [[P24]] : i64 to i64
  // CHECK: [[P27:%.*]] = llvm.shl [[P25]], [[P7]]  : i64
  // CHECK: [[P28:%.*]] = llvm.or [[P7]], [[P27]]  : i64
  // CHECK: [[P31:%.*]] = llvm.lshr [[P5]], [[P10]]  : i32
  // CHECK: [[P32:%.*]] = llvm.zext [[P31]] : i32 to i64
  // CHECK: [[P34:%.*]] = llvm.shl [[P32]], [[P20]]  : i64
  // CHECK: [[P35:%.*]] = llvm.or [[P28]], [[P34]]  : i64
  // CHECK: [[P37:%.*]] = llvm.insertvalue [[P22]], [[P36]][0] : !llvm.array<2 x i64>
  // CHECK: [[P38:%.*]] = llvm.insertvalue [[P35]], [[P37]][1] : !llvm.array<2 x i64>
  // CHECK: llvm.return [[P38]] : !llvm.array<2 x i64>
...
kgen.func @union_constant_2() -> !pop.union<i1, i2, i3, i4, i5, i6> {
  // CHECK-DAG: [[P0:%.*]] = llvm.mlir.constant(1 : i4) : i4
  // CHECK-DAG: [[P1:%.*]] = llvm.mlir.constant(0 : i64) : i64
  // CHECK-DAG: [[P2:%.*]] = llvm.mlir.constant(0 : i4) : i4
  // CHECK-DAG: [[P8:%.*]] = llvm.mlir.undef : !llvm.array<1 x i64>
  // CHECK: [[P3:%.*]] = llvm.lshr [[P0]], [[P2]]  : i4
  // CHECK: [[P4:%.*]] = llvm.zext [[P3]] : i4 to i64
  // CHECK: [[P6:%.*]] = llvm.shl [[P4]], [[P1]]  : i64
  // CHECK: [[P7:%.*]] = llvm.or [[P1]], [[P6]]  : i64
  // CHECK: [[P9:%.*]] = llvm.insertvalue [[P7]], [[P8]][0] : !llvm.array<1 x i64>
  // CHECK: llvm.return [[P9]] : !llvm.array<1 x i64>
