...
kgen.generator @fwd_reg_byref_result_store_second_debug<T: type>(%arg0: !kgen.paramref<T>, %arg1: !kgen.pointer<T> byref_result) -> !kgen.none {
  debuginfo.value #var_paramref = %arg0 : !kgen.paramref<T>
  debuginfo.value #var_pointer = %arg1 : !kgen.pointer<T>
  %none = kgen.param.constant: none = <#kgen.none>
  debuginfo.value #var_none = %none : !kgen.none
...
kgen.generator @reg_constant_debug<T: type, value: !kgen.paramref<T>>() -> !kgen.paramref<T> {
  %0 = kgen.param.constant: !kgen.paramref<T> = <value>
  debuginfo.value #var_paramref = %0 : !kgen.paramref<T>
  kgen.return %0 : !kgen.paramref<T>
}
