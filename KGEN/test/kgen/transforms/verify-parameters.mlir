...
lit.struct.decl @VariadicWrapper<T: type, V: !kgen.variadic<T>> {}

// CHECK-LABEL: lit.fn @expect_field_types_lit
// CHECK-SAME:    (%arg: !lit.struct<@VariadicWrapper<:type type, :variadic<type> #kgen.struct_field_types<T>>>
lit.fn @expect_field_types_lit<T: !kgen.type>(%arg: !lit.struct<@VariadicWrapper<:type type, :variadic<type> #kgen.struct_field_types<T>>>) -> !kgen.none {
  %none = kgen.param.constant: none = <#kgen.none>
  lit.return %none : !kgen.none
  lit.end_fn
}
...
// CHECK-SAME:    (%arg: !lit.struct<@VariadicWrapper<:type string, :variadic<string> #kgen.struct_field_names<T>>>)
lit.fn @expect_field_names_lit<T: !kgen.type>(%arg: !lit.struct<@VariadicWrapper<:type string, :variadic<string> #kgen.struct_field_names<T>>>) -> !kgen.none {
  %none = kgen.param.constant: none = <#kgen.none>
  lit.return %none : !kgen.none
  lit.end_fn
}
...
!StructFieldTypesExpected = !lit.struct<@VariadicWrapper<:type !kgen.type, :!kgen.variadic<!kgen.type> #kgen.variadic<index, i32>>>
!StructFieldNamesExpected = !lit.struct<@VariadicWrapper<:type !kgen.string, :!kgen.variadic<!kgen.string> #kgen.variadic<"first", "second">>>
...
lit.fn @use_struct_reflection_lit(%arg0: !StructFieldTypesExpected, %arg1: !StructFieldNamesExpected, %arg2: !StructFieldIndexByNameExpected, %arg3: !StructFieldTypeByNameExpected) -> !kgen.none {
  // CHECK-NEXT: lit.call @expect_field_types_lit<:type !lit.struct<@MyPair<:type index, :type i32>>>(%arg0) : !lit.generator<("arg": !lit.struct<@VariadicWrapper<:type type, :variadic<type> [index, i32]>>) -> !kgen.none>
  ...
  // CHECK-NEXT: lit.call @expect_field_names_lit<:type !lit.struct<@MyPair<:type index, :type i32>>>(%arg1) : !lit.generator<("arg": !lit.struct<@VariadicWrapper<:type string, :variadic<string> ["first", "second"]>>) -> !kgen.none>
...
kgen.struct.generator @VariadicWrapper<T: type, V: !kgen.variadic<T>> = struct_inst<"VariadicWrapper"[T,V]<:type T, :variadic<T> V>> {
  kgen.conformance @HasType {
    kgen.witness "my_type" : type = T
  }
}

#variadic_wrapper_types = #kgen.type<typevalue<#kgen.genref<@VariadicWrapper<:type type, :variadic<type> #kgen.struct_field_types<T>>>>, struct<()>> : !kgen.type
#variadic_wrapper_names = #kgen.type<typevalue<#kgen.genref<@VariadicWrapper<:type string, :variadic<string> #kgen.struct_field_names<T>>>>, struct<()>> : !kgen.type


// CHECK-LABEL: kgen.generator @expect_field_types_kgen
// CHECK-SAME:    (%arg0: !kgen.param<#kgen.get_witness<[typevalue<#kgen.genref<@VariadicWrapper<:type type, :variadic<type> #kgen.struct_field_types<T>>>>, struct<()>], "HasType", "my_type">>
...
// CHECK-SAME:    (%arg0: !kgen.param<#kgen.get_witness<[typevalue<#kgen.genref<@VariadicWrapper<:type string, :variadic<string> #kgen.struct_field_names<T>>>>, struct<()>], "HasType", "my_type">>
