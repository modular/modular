...
# RUN: mojo package %S/inputs/func_package_foo -o %t.function-thunks/func_package_foo.mojoc
# RUN: mojo package %S/inputs/func_package_bar -o %t.function-thunks/func_package_bar.mojoc
