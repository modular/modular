...
fn test():
    ...
    bind_trait[MyType]()
    # CHECK-NEXT: [!MyRegType{{[0-9]*}}, {"method" {{.*}}!lit.signature<[1]("self": !lit.ref<!MyRegType, imm *[0,0]> borrow_in_mem) -> !kgen.none>{{.*}}@MyRegType::@"method
    bind_trait[MyRegType]()
    # CHECK-NEXT: [!UseTrait{{[0-9]*}}, {"method" {{.*}}@UseTrait::@"method
    trait_method[UseTrait]()
    # CHECK-NEXT: [!UseTraitReg{{[0-9]*}}, {"method" {{.*}}!lit.signature<[1]("self": !lit.ref<!UseTraitReg, imm *[0,0]> borrow_in_mem) -> !kgen.none>{{.*}}@UseTraitReg::@"method
