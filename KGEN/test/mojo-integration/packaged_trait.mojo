...
fn test():
    ...
    bind_trait[MyType]()
    # CHECK-NEXT: [!MyRegType{{[0-9]*}}, {"method" {{.*}}fn(packaged_trait::MyRegType, /) -> None{{.*}}@MyRegType::@"method
    bind_trait[MyRegType]()
    # CHECK-NEXT: [!UseTrait{{[0-9]*}}, {"method" {{.*}}@UseTrait::@"method
    trait_method[UseTrait]()
    # CHECK-NEXT: [!UseTraitReg{{[0-9]*}}, {"method" {{.*}}fn(test_package_trait::module::UseTraitReg, /) -> None{{.*}}@UseTraitReg::@"method
