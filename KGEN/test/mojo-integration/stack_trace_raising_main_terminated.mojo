...
# O3-FULL: #{{.*}} stdlib::builtin::_startup::__wrap_and_execute_raising_main{{.*}}raises{{.*}}main()" {{.*}}_startup.mojo:{{.*}}:{{.*}}
...
# O0-FULL: #{{.*}} stdlib::builtin::_startup::__wrap_and_execute_raising_main{{.*}}raises{{.*}}main()" {{.*}}_startup.mojo:{{.*}}:{{.*}}
...
# O0-NONE: #{{.*}} stdlib::builtin::_startup::__wrap_and_execute_raising_main{{.*}}raises{{.*}}main()"
# O0-NONE: #{{.*}} main
