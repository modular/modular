...
# RUN: mojo package %S/inputs/struct_only_package -o %t.cross-package-extension/struct_only_package.mojoc
# RUN: mojo package -I %t.cross-package-extension %S/inputs/extension_only_package -o %t.cross-package-extension/extension_only_package.mojoc
