...
fn callsWith():
  testAsyncVoid() # expected-warning {{awaitable 'Coroutine[1, None, #lit.lifetime]' value was never awaited}}
  testAsyncInt() # expected-warning {{awaitable 'Coroutine[1, Int, #lit.lifetime]' value was never awaited}}
