...
fn test3830():
    ...
    # expected-note @below {{failed to infer parameter 'a_is_origin', it inferred to two different values: '__origin_of((muttoimm anonymous*))' and '__origin_of((muttoimm anonymous*))', try `rebind` them to one type if they will be concretized to the same type}}
