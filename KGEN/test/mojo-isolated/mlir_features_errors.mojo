...
# expected-note @below {{argument #0 with convention 'mut' in signature type should be a `!kgen.pointer`}}
fn bad_signature_type[func: __mlir_type[`!kgen.signature<(index mut) -> !kgen.none>`]]():
    pass
