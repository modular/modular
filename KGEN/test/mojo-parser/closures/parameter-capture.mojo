...
# CHECK: lit.func @"__init__{{.*}}_CW_{{.*}}"<[[p0:.*]][[[p0]]]: !Int, |>(%self[self]: !kgen.pointer<!escaping> init_self, %impl[impl]: !kgen.pointer<@"{{.*}}::@"_CI_{{.*}}"<p0: !Int = [[p0]]>> borrow_in_mem, |) -> !kgen.none attributes {specialFnKind = 2 : i8} {
