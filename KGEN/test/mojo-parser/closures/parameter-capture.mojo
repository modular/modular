...
# CHECK-NEXT: lit.alias.decl *"[[XREF:.*]]": @"${{.*}}"::@Foo<:!Int p0> =
# CHECK-SAME: <apply(:!lit.signature<("b": !Int borrow, |) ownedresult -> !kgen.declref<@"${{.*}}"::@Foo<:!Int p0>>> @"${{.*}}"::@Foo::@"__init__{{.*}}"<:!Int p0>, #lit.struct<{value = 1}>)>
