...
# CHECK-SAME: conforms_to(:!kgen.param<:meta<!lit.meta<!Int>> *(0,0)> *(0,1), :!lit.anytrait<!Bar_AnyType> !Bar_AnyType)
...
# CHECK-SAME: conforms_to(:param_list<!AnyType> *(0,0), :!lit.anytrait<!Bar_AnyType> !Bar_AnyType)
