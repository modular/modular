...
fn infer_two_param_dep_struct[y: Int]():
    ...
    # expected-error @+1 {{value passed to 'a' cannot be converted from 'TwoIntParamStruct[2, 2]' to 'TwoIntParamStruct[x, (x + 1)]'}}
    take_two_int_dep(TwoIntParamStruct[2, 2]())
    take_two_int_dep(TwoIntParamStruct[b=2, a=1]())

    take_two_int_dep(TwoIntParamStruct[y, y + 1]())
    # expected-error @+1 {{value passed to 'a' cannot be converted from 'TwoIntParamStruct[y, (y + 2)]' to 'TwoIntParamStruct[x, (x + 1)]'}}
