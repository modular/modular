...
def call_test_ref(mut s: String):
    # expected-error @+1 {{cannot use parameterized function of type 'def[mut: Bool, +, origin: Origin[mut=mut]](ref[_mlir_origin] arg: String) -> None' without binding all its parameters}}
    var f1 = test_ref
