...
def test_mergewith_pointer():
    ...
    # expected-error @below {{aliasing values passed mutably to 'elements' argument and mutably to 'elements' argument in 'List[Pointer[Int, origin_of(a, b)]]' initializer call}}
