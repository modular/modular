...
def test_func_type():
    ...
    # expected-error @below {{'def[Ts: Variadic[AnyType], ?, .origin._mlir_origin``31: LITMutOrigin, .origin`32: MutOrigin](var * *Ts) capturing -> None'}}
    comptime float6: def[*Ts: AnyType](var* *Ts) capturing -> None = test_func_type
    # expected-error @below {{'def[Ts: Variadic[AnyType], ?, .origin._mlir_origin``34: LITMutOrigin, .origin`35: MutOrigin](var * *Ts) capturing -> None'}}
