...
fn fn_doesnt_raise() -> Int:
    pass


fn fn_returns_ref(x: String) -> ref[x] String:
    pass
...
struct ToTypeImm:
    ...
    @implicit
    fn __init__[O: Origin[]](out self, ref[O] f: FromType):
        self.n = f.n
...
struct ToTypeMut:
    ...
    @implicit
    fn __init__[O: Origin[mut=True]](out self, ref[O] f: FromType):
        self.n = f.n
