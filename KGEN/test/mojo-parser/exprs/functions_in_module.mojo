...
# CHECK-SAME: <store_to_mem(@functions_in_module::@"foo()"), store_to_mem(@functions_in_module::@"bar(::SIMD[::DType(int), ::SIMDSize(1)])"), store_to_mem(@functions_in_module::@"bar(::SIMD[::DType(int), ::SIMDSize(1)],::SIMD[::DType(int), ::SIMDSize(1)])"), store_to_mem(@functions_in_module::@"baz()"), store_to_mem(@functions_in_module::@"take[::AnyType & ::Movable,$0]()"{{.*}})>))
