...
def tuples_rv(a: Int, b: FloatDyn):
    # CHECK: [[TMPVAR:%.*]] = lit.var.decl{{.*}}Tuple <:variadic<!Movable> []>>,
...
# CHECK-SAME: %__result__: !lit.ref<{{.*}}#Tuple <:variadic<!Movable> []>
...
# CHECK-SAME: %__result__: !lit.ref<{{.*}}#Tuple <:variadic<!Movable> [!Int]>>,
def returnTup1() -> Tuple[Int]:
    # CHECK: %0 = kgen.param.constant: !Int
    # CHECK:   = lit.ref.pack.create({{.*}}) : !lit.ref.pack<:variadic<!Movable> [!Int],
...
# CHECK-SAME:  %__result__: !lit.ref<{{.*}}#Tuple <:variadic<!Movable> [!Int, !FloatDyn]>
def returnTup2() -> Tuple[Int, FloatDyn]:
    # CHECK:  = kgen.param.constant: !Int = <{4}>
    # CHECK:  = kgen.param.constant: !FloatDyn = <{{.*}}{:scalar<f64> "2"}
    # CHECK: lit.ref.pack.create({{.*}}) : !lit.ref.pack<:variadic<!Movable> [!Int, !FloatDyn]
    return (Int(4), 2.0)
...
# CHECK-SAME: #Tuple <:variadic<!Movable> [!kgen.param<:!ImplicitlyCopyable T>, !kgen.param<:!ImplicitlyCopyable T>]>
