...
fn test_package_import_in_function():
    import test_package
    test_package.method_defined_in_init() # ok

# // -----

fn test_dotted_module_import_in_function():
...
fn test_dotted_package_import_in_function():
...
fn test_from_package_import_module_in_function():
    from test_package import module
    module.function()  # ok

# // -----

fn test_from_package_import_package_in_function():
    from test_package import test_nested_package
    test_nested_package.nested_function()  # ok

# // -----

fn test_from_nested_package_import_symbol_in_function():
