...
fn var_let_decls():
    ...
    # CHECK: lit.alias.decl {{.*}}fl1{{.*}}@FloatLiteral<:!kgen.float_literal #kgen.float_literal<2|1>> = <*?>
    alias fl1 = 2.0
    # CHECK: lit.alias.decl {{.*}}fl2{{.*}}@FloatLiteral<:!kgen.float_literal #kgen.float_literal<63|10>> = <*?>
    alias fl2 = 6.3
    # CHECK: lit.alias.decl {{.*}}fl3{{.*}}@FloatLiteral<:!kgen.float_literal #kgen.float_literal<41|2>> = <*?> 
    alias fl3 = 20.5
    # CHECK: lit.alias.decl {{.*}}fl4{{.*}}@FloatLiteral<:!kgen.float_literal #kgen.float_literal<-41|2>> = <*?> 
    alias fl4 = -20.5
