...
# CHECK-SAME: where {<eq(#kgen.variadic.size<#kgen.param.decl.ref<"a`"> : !kgen.variadic<!Int>>, 2), #{{[[:alnum:]]+}}>, <eq(#kgen.variadic.size<#kgen.param.decl.ref<"a`2"> : !kgen.variadic<!Int>>, 2), #{{[[:alnum:]]+}}>}
