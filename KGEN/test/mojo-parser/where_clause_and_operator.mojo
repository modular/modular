...
# CHECK-SAME: and(#lit.struct.extract<:!Bool apply(:!lit.generator<("x": !Int) -> !Bool> @where_clause_and_operator::@"bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
def test_and_bool[
    x: Int, y: Int, z: Int
...
# CHECK-SAME: {<sugar_preserved(cond(apply(:!lit.generator<("x": !Int) -> !kgen.scalar<bool>> @where_clause_and_operator::@"scalar_bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
# CHECK-SAME: and(apply(:!lit.generator<("x": !Int) -> !kgen.scalar<bool>> @where_clause_and_operator::@"scalar_bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
...
# CHECK-SAME: {<sugar_preserved(#lit.struct.extract<:!Bool cond(apply(:!lit.generator<("x": !Int) -> !kgen.scalar<bool>> @where_clause_and_operator::@"scalar_bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
# CHECK-SAME: and(apply(:!lit.generator<("x": !Int) -> !kgen.scalar<bool>> @where_clause_and_operator::@"scalar_bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
...
# CHECK-SAME: {<sugar_preserved(#lit.struct.extract<:!Bool
# CHECK-SAME: or(#lit.struct.extract<:!Bool apply(:!lit.generator<("x": !Int) -> !Bool> @where_clause_and_operator::@"bool_pred(::SIMD[::DType(int), ::SIMDSize(1)])"
