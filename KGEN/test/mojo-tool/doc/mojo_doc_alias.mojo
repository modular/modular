...
# CHECK-LABEL: "name": "x2"
# CHECK: "value": "Tuple[IndexList[3]](VariadicPack[True, True, {}, Copyable & Movable, IndexList[3]](Index(64, 8, 8)))"
alias x2 = (Index(64, 8, 8),)

# CHECK-LABEL: "name": "x3"
# CHECK: "value": "Tuple[Int, Int](VariadicPack[True, True, {}, Copyable & Movable, Int, Int](1, 1))"
