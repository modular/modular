...
#
# RUN 1: mojo doc on test_std_mock (an opted-in package).
# RUN 2: mojo doc on this file (outside any opted-in package).

# RUN: mojo doc %S/test_std_mock | FileCheck %s --check-prefix TRACKED
# RUN: mojo doc %s | FileCheck %s --check-prefix UNTRACKED
