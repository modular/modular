...
# CHECK-WARN: mojo_doc_validate.mojo:{{.*}}warning: unknown argument
...
# CHECK-VALIDATE: mojo_doc_validate.mojo:{{.*}}error: unknown argument
# CHECK-VALIDATE-NOT: "name": "mojo_doc_validate",
