...
# RUN: mojo demangle '$AModule::AStruct::print[$Builtin::$Int::Int,$DType::DType]($SIMD::SIMD[*(0,1), *(0,0)])' | FileCheck -check-prefix=PARAMETRIZEDARG2 %s
# PARAMETRIZEDARG2: Mangled: "$AModule::AStruct::print[$Builtin::$Int::Int,$DType::DType]($SIMD::SIMD[*(0,1), *(0,0)])" - Modules: ["AModule"], Structs: ["AStruct"], Symbol: "print[$Builtin::$Int::Int,$DType::DType]", Identifier: "print", Signature: (none)
