...
# RUN: mojo run --help | FileCheck %s --check-prefix CHECK-HELP
# RUN: mojo run --help %s | FileCheck %s --check-prefix CHECK-HELP
...
# RUN: mojo run %s --help | FileCheck %s --check-prefix CHECK-NOT-HELP
# RUN: mojo %s --help | FileCheck %s --check-prefix CHECK-NOT-HELP
