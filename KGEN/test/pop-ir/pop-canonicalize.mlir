...
kgen.func @struct_get() -> si4 {
  ...
  %1 = pop.struct.extract %0[0] : !pop.struct<si4, ui4>
  kgen.return %1 : si4
}
...
kgen.func @variadic_create() -> !pop.variadic<index> {
  // CHECK-NEXT: kgen.param.constant{{.*}} = <#pop.variadic<13, 17>>
  %0 = index.constant 13
  %1 = index.constant 17
  %2 = pop.variadic.create [%0, %1] : !pop.variadic<index>
  kgen.return %2 : !pop.variadic<index>
}

// CHECK-LABEL: @variadic_get(
kgen.func @variadic_get() -> i32 {
  // CHECK-NEXT: kgen.param.constant: i32 = <11>
  %0 = kgen.param.constant: !pop.variadic<i32> = <#pop.variadic<7, 11, 13>>
  %1 = index.constant 1
  %2 = pop.variadic.get %0[%1] : !pop.variadic<i32>
  kgen.return %2 : i32
}
...
kgen.func @variadic_create_get(%arg0: i32, %arg1: i32) -> i32 {
  ...
  %0 = pop.variadic.create [%arg0, %arg1] : !pop.variadic<i32>
  %1 = index.constant 0
  %2 = pop.variadic.get %0[%1] : !pop.variadic<i32>
  kgen.return %2 : i32
}
...
kgen.func @variadic_size() -> index {
  ...
  %0 = kgen.param.constant: !pop.variadic<i32> = <#pop.variadic<7, 11, 13>>
  %1 = pop.variadic.size %0 : !pop.variadic<i32>
  kgen.return %1 : index
}
