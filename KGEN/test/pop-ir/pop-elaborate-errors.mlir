...
kgen.generator @clobber_pointer(%arg0: i16) -> i16 {
  ...
  %1 = pop.stack_allocation 1 x !pop.pointer<i64>
  pop.store %0, %1 : !pop.pointer<pointer<i64>>
  %2 = pop.pointer.bitcast %1 : !pop.pointer<pointer<i64>> to !pop.pointer<i16>
  %idx1 = index.constant 1
  %3 = pop.offset %2[%idx1] : !pop.pointer<i16>
  // expected-note @below {{failed to interpret operation pop.store}}
  // expected-note @below {{write clobbers a pointer region}}
  pop.store %arg0, %3 : !pop.pointer<i16>
...
kgen.generator @clobber_pointer(%arg0: i64) -> i64 {
  %0 = pop.stack_allocation 1 x i64
  %1 = pop.stack_allocation 1 x !pop.struct<i64, !pop.pointer<i64>>
  %2 = pop.struct.gep %1[1] : <struct<i64, !pop.pointer<i64>>>
  pop.store %0, %2 : !pop.pointer<pointer<i64>>
  %3 = pop.struct.gep %1[0] : <struct<i64, !pop.pointer<i64>>>
  %4 = pop.pointer_to_index %3 : !pop.pointer<i64> to !pop.scalar<index>
  %idx2 = kgen.param.constant: scalar<index> = <1>
  %5 = pop.add %4, %idx2 : !pop.scalar<index>
  %6 = pop.index_to_pointer %5 : !pop.scalar<index> to !pop.pointer<i64>
  // expected-note @below {{failed to interpret operation pop.store}}
  // expected-note @below {{write clobbers a pointer region}}
  pop.store %arg0, %6 : !pop.pointer<i64>
