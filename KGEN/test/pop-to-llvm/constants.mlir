...
kgen.func @variant_constant_0() -> !pop.variant<i32> {
  ...
  %0 = kgen.param.constant: variant<i32> = <#pop.variant<:i32 1>>
...
kgen.func @variant_constant_1() -> !pop.variant<struct<i32, i64, i32>, struct<f64, f32>> {
  ...
  %0 = kgen.param.constant: variant<struct<i32, i64, i32>, struct<f64, f32>> = <#pop.variant<:!pop.struct<i32, i64, i32> { 1, 2, 3 }>>
...
kgen.func @variant_constant_2() -> !pop.variant<i1, i2, i3, i4, i5, i6> {
  ...
  %0 = kgen.param.constant: variant<i1, i2, i3, i4, i5, i6> = <#pop.variant<:i4 1>>
