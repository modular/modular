...
kgen.func @variant_create_1(%arg0: i8) -> !pop.variant<i8> {
  // CHECK-DAG: %[[I64_0:.*]] = llvm.mlir.constant(0 : i64)
...
kgen.func @variant_create_2(%arg0: f64) -> !pop.variant<f64> {
...
kgen.func @variant_create_3(%arg0: !pop.struct<i32, i32>) -> !pop.variant<struct<i32, i32>> {
...
kgen.func @variant_create_4(%arg0: !pop.struct<i32, i64, i32>) -> !pop.variant<struct<i32, i64, i32>, array<4, i64>> {
  // CHECK-DAG: %[[I64_32:.*]] = llvm.mlir.constant(32 : i64)
  // CHECK-DAG: %[[I32_0:.*]] = llvm.mlir.constant(0 : i32)
  // CHECK-DAG: %[[I64_0:.*]] = llvm.mlir.constant(0 : i64)
  // CHECK: %[[P4:.*]] = builtin.unrealized_conversion_cast %arg0
  // CHECK: %[[P5:.*]] = llvm.extractvalue %[[P4]][0] : !llvm.struct<(i32, i64, i32)>
  // CHECK: %[[P6:.*]] = llvm.lshr %[[P5]], %[[I32_0]] : i32
  // CHECK: %[[P7:.*]] = llvm.zext %[[P6]] : i32 to i64
  // CHECK: %[[P8:.*]] = llvm.shl %[[P7]], %[[I64_0]] : i64
  // CHECK: %[[P9:.*]] = llvm.or %[[I64_0]], %[[P8]] : i64
  // CHECK: %[[P10:.*]] = llvm.extractvalue %[[P4]][1] : !llvm.struct<(i32, i64, i32)>
  ...
  // CHECK: %[[P19:.*]] = llvm.extractvalue %[[P4]][2] : !llvm.struct<(i32, i64, i32)>
...
kgen.func @variant_create_5(%arg0: !pop.struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>>) -> !pop.variant<struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>>> {
  // CHECK-DAG: %[[I32_1:.*]] = llvm.mlir.constant(1 : i32)
  // CHECK-DAG: %[[I64_8:.*]] = llvm.mlir.constant(8 : i64)
  // CHECK-DAG: %[[I32_24:.*]] = llvm.mlir.constant(24 : i32)
  // CHECK-DAG: %[[I64_40:.*]] = llvm.mlir.constant(40 : i64)
  // CHECK-DAG: %[[I32_0:.*]] = llvm.mlir.constant(0 : i32)
  // CHECK-DAG: %[[I64_32:.*]] = llvm.mlir.constant(32 : i64)
  // CHECK-DAG: %[[I8_0:.*]] = llvm.mlir.constant(0 : i8)
  ...
  // CHECK-DAG: %[[I64_0:.*]] = llvm.mlir.constant(0 : i64)
  // CHECK: %[[P11:.*]] = builtin.unrealized_conversion_cast %arg0 : !pop.struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>> to !llvm.struct<(array<2 x i16>, struct<(struct<(i8, i32)>, vector<2xf32>)>)>
  // CHECK: %[[P12:.*]] = llvm.extractvalue %[[P11]][0] : !llvm.struct<(array<2 x i16>, struct<(struct<(i8, i32)>, vector<2xf32>)>)>
  ...
  // CHECK: %[[P23:.*]] = llvm.extractvalue %[[P11]][1] : !llvm.struct<(array<2 x i16>, struct<(struct<(i8, i32)>, vector<2xf32>)>)>
  ...
  // CHECK: %[[P28:.*]] = llvm.shl %[[P27]], %[[I64_32]] : i64
  // CHECK: %[[P29:.*]] = llvm.or %[[P22]], %[[P28]] : i64
  // CHECK: %[[P30:.*]] = llvm.extractvalue %[[P24]][1] : !llvm.struct<(i8, i32)>
  // CHECK: %[[P31:.*]] = llvm.lshr %[[P30]], %[[I32_0]] : i32
  // CHECK: %[[P32:.*]] = llvm.zext %[[P31]] : i32 to i64
  // CHECK: %[[P33:.*]] = llvm.shl %[[P32]], %[[I64_40]] : i64
  // CHECK: %[[P34:.*]] = llvm.or %[[P29]], %[[P33]] : i64
  // CHECK: %[[P35:.*]] = llvm.lshr %[[P30]], %[[I32_24]] : i32
  // CHECK: %[[P36:.*]] = llvm.zext %[[P35]] : i32 to i64
  // CHECK: %[[P37:.*]] = llvm.shl %[[P36]], %[[I64_0]] : i64
  // CHECK: %[[P38:.*]] = llvm.or %[[I64_0]], %[[P37]] : i64
  ...
  // CHECK: %[[P44:.*]] = llvm.shl %[[P43]], %[[I64_8]] : i64
  // CHECK: %[[P45:.*]] = llvm.or %[[P38]], %[[P44]] : i64
  ...
  // CHECK: %[[P50:.*]] = llvm.shl %[[P49]], %[[I64_40]] : i64
  // CHECK: %[[P51:.*]] = llvm.or %[[P45]], %[[P50]] : i64
  // CHECK: %[[P52:.*]] = llvm.lshr %[[P47]], %[[I32_24]] : i32
  // CHECK: %[[P53:.*]] = llvm.zext %[[P52]] : i32 to i64
  // CHECK: %[[P54:.*]] = llvm.shl %[[P53]], %[[I64_0]] : i64
  // CHECK: %[[P55:.*]] = llvm.or %[[I64_0]], %[[P54]] : i64
  // CHECK: %[[S0:.*]] = llvm.insertvalue %[[P34]], %{{.*}}[0] : !llvm.array<3 x i64>
  // CHECK: %[[S1:.*]] = llvm.insertvalue %[[P51]], %[[S0]][1] : !llvm.array<3 x i64>
  // CHECK: %[[S2:.*]] = llvm.insertvalue %[[P55]], %[[S1]][2] : !llvm.array<3 x i64>
...
kgen.func @variant_get_0(%arg0: !pop.variant<i32>) ->  i32{
...
kgen.func @variant_get_2(%arg0: !pop.variant<struct<i32, i32>>) -> !pop.struct<i32, i32>{
...
kgen.func @variant_get_3(%arg0: !pop.variant<struct<i32, i64, i32>, array<4, i64>>) -> !pop.struct<i32, i64, i32> {
  // CHECK: %[[C32_i64:.*]] = llvm.mlir.constant(32 : i64)
  // CHECK: %[[C0_i64:.*]] = llvm.mlir.constant(0 : i64)
  // CHECK: %[[C0_i32:.*]] = llvm.mlir.constant(0 : i32)
  // CHECK: %[[P3:.*]] = builtin.unrealized_conversion_cast %arg0 : !pop.variant<struct<i32, i64, i32>, array<4, i64>> to !llvm.struct<(array<4 x i64>, i1)>
  // CHECK: %[[P4:.*]] = llvm.extractvalue %[[P3]][0] : !llvm.struct<(array<4 x i64>, i1)>
...
kgen.func @variant_get_4(%arg0: !pop.variant<struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>>>) -> !pop.struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>> {
  // CHECK: %[[C1_i32:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK: %[[C8_i64:.*]] = llvm.mlir.constant(8 : i64) : i64
  // CHECK: %[[C24_i64:.*]] = llvm.mlir.constant(24 : i64) : i64
  // CHECK: %[[C40_i64:.*]] = llvm.mlir.constant(40 : i64) : i64
  // CHECK: %[[C0_i32:.*]] = llvm.mlir.constant(0 : i32) : i32
  // CHECK: %[[C32_i64:.*]] = llvm.mlir.constant(32 : i64) : i64
  // CHECK: %[[C0_i8:.*]] = llvm.mlir.constant(0 : i8) : i8
  // CHECK: %[[C16_i64:.*]] = llvm.mlir.constant(16 : i64) : i64
  // CHECK: %[[C0_i64:.*]] = llvm.mlir.constant(0 : i64) : i64
  // CHECK: %[[C0_i16:.*]] = llvm.mlir.constant(0 : i16) : i16
  // CHECK: %[[P10:.*]] = builtin.unrealized_conversion_cast %arg0 : !pop.variant<struct<array<2, i16>, struct<struct<i8, i32>, simd<2, f32>>>> to !llvm.struct<(array<3 x i64>, i1)>
  // CHECK: %[[P11:.*]] = llvm.extractvalue %[[P10]][0] : !llvm.struct<(array<3 x i64>, i1)>
  ...
  // CHECK: %[[P30:.*]] = llvm.lshr %[[P12]], %[[C32_i64]] : i64
  ...
  // CHECK: %[[P35:.*]] = llvm.lshr %[[P12]], %[[C40_i64]] : i64
  // CHECK: %[[P36:.*]] = llvm.shl %[[P35]], %[[C0_i64]] : i64
  // CHECK: %[[P37:.*]] = llvm.trunc %[[P36]] : i64 to i32
  // CHECK: %[[P38:.*]] = llvm.or %[[C0_i32]], %[[P37]] : i32
  // CHECK: %[[P39:.*]] = llvm.lshr %[[P13]], %[[C0_i64]] : i64
  // CHECK: %[[P40:.*]] = llvm.shl %[[P39]], %[[C24_i64]] : i64
  // CHECK: %[[P41:.*]] = llvm.trunc %[[P40]] : i64 to i32
  // CHECK: %[[P42:.*]] = llvm.or %[[P38]], %[[P41]] : i32
  // CHECK: %[[P43:.*]] = llvm.insertvalue %[[P42]], %[[P34]][1] : !llvm.struct<(i8, i32)>
  // CHECK: %[[P44:.*]] = llvm.insertvalue %[[P43]], %[[P28]][0] : !llvm.struct<(struct<(i8, i32)>, vector<2xf32>)>
  // CHECK: %[[P45:.*]] = llvm.mlir.undef : vector<2xf32>
  // CHECK: %[[P46:.*]] = llvm.lshr %[[P13]], %[[C8_i64]] : i64
  ...
  // CHECK: %[[P52:.*]] = llvm.lshr %[[P13]], %[[C40_i64]] : i64
  // CHECK: %[[P53:.*]] = llvm.shl %[[P52]], %[[C0_i64]] : i64
  // CHECK: %[[P54:.*]] = llvm.trunc %[[P53]] : i64 to i32
  // CHECK: %[[P55:.*]] = llvm.or %[[C0_i32]], %[[P54]] : i32
  // CHECK: %[[P56:.*]] = llvm.lshr %[[P14]], %[[C0_i64]] : i64
  // CHECK: %[[P57:.*]] = llvm.shl %[[P56]], %[[C24_i64]] : i64
  // CHECK: %[[P58:.*]] = llvm.trunc %[[P57]] : i64 to i32
  // CHECK: %[[P59:.*]] = llvm.or %[[P55]], %[[P58]] : i32
  // CHECK: %[[P60:.*]] = llvm.bitcast %[[P59]] : i32 to f32
