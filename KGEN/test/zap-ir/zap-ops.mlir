...
kgen.func @zap_ndbuffer_load_aligned(
  ...
  %2 = zap.ndbuffer.load %ndbuffer1[%idx, %idx] align get_alignof(f32, #target) : !zap.ndbuffer<[4, ?], f32>, !pop.simd<3, f32>
...
kgen.func @zap_ndbuffer_store_aligned(
  ...
  zap.ndbuffer.store %val, %ndbuffer1[%idx, %idx] align get_alignof(f32, #target) : !pop.simd<4, f32>, !zap.ndbuffer<[4, ?], f32>
  // CHECK: zap.ndbuffer.store %[[VAL]], %[[NDBUFFER2]][%[[IDX]]] align 8 : !pop.simd<4, f32>, !zap.ndbuffer<[?], f32>
  zap.ndbuffer.store %val, %ndbuffer2[%idx] align get_alignof(f64, #target) : !pop.simd<4, f32>, !zap.ndbuffer<[?], f32>
  kgen.return
}
