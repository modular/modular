...
#   Path:   tests/data/preview/comments7.py
#
# ===----------------------------------------------------------------------=== #
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"metadata_version": "-1"},
                (
                    "'-1' is an invalid value for Metadata-Version. Error:"
                    " Unknown Metadata Version see"
                    " https://packaging.python.org/specifications/core-metadata"
                ),
            ),
            # name errors.
            ...
            (
                {"metadata_version": "1.2", "name": "foo-"},
                (
                    "'foo-' is an invalid value for Name. Error: Must start and"
                    " end with a letter or numeral and contain only ascii"
                    " numeric and '.', '_' and '-'. see"
                    " https://packaging.python.org/specifications/core-metadata"
                ),
            ),
            # version errors.
            ...
            (
                ...
                (
                    "'dog' is an invalid value for Version. Error: Must start"
                    " and end with a letter or numeral and contain only ascii"
                    " numeric and '.', '_' and '-'. see"
                    " https://packaging.python.org/specifications/core-metadata"
                ),
            ),
