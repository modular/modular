...
export class MojoLSPContext extends DisposableContext {
   ...
   */
  activateLanguageClient(launchServerWithDebuggerAttached: boolean,
                         sdk: MojoSDK,
                         includeDirs: string[]): vscodelc.LanguageClient {
    ...
    const clientOptions: vscodelc.LanguageClientOptions = {
      ...
      synchronize : {
        ...
        // pattern.
        fileEvents :
            vscode.workspace.createFileSystemWatcher('**/*.{mojo,🔥,ipynb}'),
      },
    ...
    let languageClient = new vscodelc.LanguageClient(
        'mojo-lsp', 'Mojo Language Client', serverOptions, clientOptions);
