...
auto runWithLeakCheckedRuntime(
    const RuntimeCLOptions &options, const char *testName, BodyFn bodyFn,
  ...
  // done.
  return bodyFn(*options.createRuntime(std::move(globalContextObjects)));
}
