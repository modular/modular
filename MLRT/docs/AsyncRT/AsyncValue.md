...
[`AsyncValue`](../../include/MLRT/AsyncRT/Runtime/AsyncValue.h) is conceptually
similar to [std::future](https://en.cppreference.com/w/cpp/thread/future),
except that `AsyncValue` does not let callers wait/block until the value becomes
available. Instead, the caller enqueues a closure that uses the value with
...
the [`RCRef`](../include/Support/RCRef.h) and
[`AsyncValueRef<T>`](../../include/MLRT/AsyncRT/Runtime/AsyncValueRef.h) classes
whenever possible to maintain their lifetime.
