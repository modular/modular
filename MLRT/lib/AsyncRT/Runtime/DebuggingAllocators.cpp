...
M::MLRT::createLeakCheckAllocator(std::unique_ptr<Allocator> baseAllocator) {
...
public:
  ...
  ~ProfilingAllocator() override {
    llvm::errs() << "-----------------------------------------------------\n";
    llvm::errs() << "M::MLRT::Allocator profile:\n";
...
std::unique_ptr<Allocator>
M::MLRT::createProfilingAllocator(std::unique_ptr<Allocator> baseAllocator) {
...
std::unique_ptr<Allocator> M::MLRT::createUseAfterFreeAllocator() {
