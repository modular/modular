...
def main() raises:
    ...
    var name: String                  # declare before use
...
assignment doesn't imply ownership, reference, or memory semantics. Plus, the
value on the right needn't exist in memory; it might exist only in a register.
