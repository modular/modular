...
- Added a section to the *Value destruction* page about how to implement
  ...
  types](/docs/manual/lifecycle/death/).
...
- Added a [`CStringSlice`](/docs/std/ffi/cstring/CStringSpan/) as a
...
- The [`UInt`](/docs/std/simd/#uint) struct has been replaced by a new
...
- Added support for [`SIMD`](/docs/std/simd/SIMD/) expressions in
  `where` clauses:
