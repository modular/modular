...
- Mojo now supports a standalone `assert` statement, similar to Python's
  ...
  `String`, [`Int`](/docs/std/simd/#int), etc.). Under
...
- Implicit conversions from `Int` to [`SIMD`](/docs/std/simd/SIMD/) are now
  deprecated, and will be removed in a future version of Mojo. This includes
...
- [`Int.__truediv__()`](/docs/std/simd/SIMD/#__truediv__)
...
- Added
  [`uninit_move_n()`](/docs/std/memory/memory/unsafe_uninit_move_n/),
  [`uninit_copy_n()`](/docs/std/memory/memory/unsafe_uninit_copy_n/),
  and
  [`destroy_n()`](/docs/std/memory/memory/unsafe_destroy_n/)
