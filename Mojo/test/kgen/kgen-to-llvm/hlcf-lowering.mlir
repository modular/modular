...
kgen.func @comptime_match(%arg0: !kgen.scalar<bool>, %arg1: i32, %arg2: i32) -> i32 {
  // Entry branches to the first case (region #1; else is inlined first as ^bb1).
  // CHECK-NEXT: %[[A0SB:.*]] = builtin.unrealized_conversion_cast %arg0 : i1 to !kgen.scalar<bool>
  // CHECK-NEXT: llvm.br ^bb2
  %0 = hlcf.comptime.match <:!kgen.scalar<bool> true> -> i32 {
    hlcf.if %arg0 {
      hlcf.match.complete %arg1 : i32
    } else {
      hlcf.match.next
...
kgen.func @comptime_match_next_to_else(%arg0: i32, %arg1: i32) -> i32 {
  // CHECK-NEXT: llvm.br ^bb2
...
kgen.func @nested_comptime_match(%arg0: i32, %arg1: i32) -> i32 {
  // CHECK-NEXT: llvm.br ^bb1
  %0 = hlcf.comptime.match <0> -> i32 {
    // CHECK-NEXT: ^bb1:
    // CHECK-NEXT: llvm.br ^bb3
