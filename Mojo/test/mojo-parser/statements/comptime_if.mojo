...
def param_if_andor_i1[a: __mlir_type.`!kgen.scalar<bool>`, b: __mlir_type.`!kgen.scalar<bool>`]():
    # CHECK: hlcf.comptime.if <cond(a, b, a)>
    comptime if a and b:
...
def param_if_and[a: Bool, b: Bool]():
    # CHECK: hlcf.comptime.if <#lit.struct.extract<:!Bool cond(#lit.struct.extract<:!Bool a, "_mlir_value">, b, a), "_mlir_value">> {
    comptime if a and b:
        # CHECK:   lit.var.decl "v" var
        var v: Int
    # CHECK:   hlcf.comptime.yield
