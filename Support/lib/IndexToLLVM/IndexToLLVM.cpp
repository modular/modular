...
static void populateIndexToLLVMPatterns(mlir::LLVMTypeConverter &typeConverter,
...
namespace M::index {
#define GEN_PASS_DEF_INDEXTOLLVM
#include "Support/IndexDialect/IndexToLLVM.h.inc"
} // namespace M::index
...
void IndexToLLVMPass::runOnOperation() {
  ...
  populateIndexToLLVMPatterns(typeConverter, patterns);
