...
// CHECK-DAG: #[[OPAQUE_PTR:.*]] = #llvm.di_derived_type<tag = DW_TAG_pointer_type, baseType = #[[OPAQUE_BASE]], sizeInBits = {{.*}}, alignInBits = {{.*}}, offsetInBits = 0>
...
// CHECK-DAG: #[[PTR:.*]] = #llvm.di_derived_type<tag = DW_TAG_pointer_type, baseType = #[[I32]], sizeInBits = {{.*}}, alignInBits = {{.*}}, offsetInBits = 0>
...
// CHECK-DAG: #[[STRUCT_MEM1:.*]] = #llvm.di_derived_type<tag = DW_TAG_member, name = "field_0", baseType = #[[I32]], sizeInBits = 32, alignInBits = 32, offsetInBits = 0>
...
// CHECK-DAG: #[[STRUCT:.*]] = #llvm.di_composite_type<tag = DW_TAG_structure_type, name = "", line = 0, sizeInBits = {{.*}}, alignInBits = {{.*}}, elements = #di_derived_type2, #di_derived_type3>
!struct = !debuginfo.unresolved<!llvm.struct<(i32, i64)>>

// CHECK-DAG: #[[NAMED_STRUCT_MEM1:.*]] = #llvm.di_derived_type<tag = DW_TAG_member, name = "field_0", baseType = #[[PTR]], sizeInBits = {{.*}}, alignInBits = {{.*}}, offsetInBits = 0>
...
// CHECK-DAG: #[[NAMED_STRUCT:.*]] = #llvm.di_composite_type<tag = DW_TAG_structure_type, name = "Buffer", line = 0, sizeInBits = {{.*}}, alignInBits = {{.*}}, elements = #[[NAMED_STRUCT_MEM1]], #[[NAMED_STRUCT_MEM2]]>
!namedStruct = !debuginfo.unresolved<!llvm.struct<"Buffer", (ptr<i32>, i64)>>

// CHECK-DAG: #[[ARRAY:.*]] = #llvm.di_composite_type<tag = DW_TAG_array_type, name = "", line = 0, baseType = #[[I32]], sizeInBits = 320, alignInBits = 0, elements = #llvm.di_subrange<count = 10 : i64>>
!array = !debuginfo.unresolved<!llvm.array<10 x i32>>

// CHECK-DAG: #[[VECTOR:.*]] = #llvm.di_composite_type<tag = DW_TAG_array_type, name = "", line = 0, baseType = #[[PTR]], flags = Vector, sizeInBits = {{.*}}, alignInBits = 0, elements = #llvm.di_subrange<count = 10 : i64>>
