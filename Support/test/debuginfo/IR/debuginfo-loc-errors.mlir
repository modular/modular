...
func.func @foo(%arg: i32) {
  // CHECK: foo.mlir:7:8: error: 'debuginfo.value' op location scope must match variable scope: #debuginfo.file<"foo.mlir" in "/mlir/"> vs. #debuginfo.subprogram
...
func.func @bar(%arg: i32) {
  // CHECK: bar.mlir:5:6: error: 'debuginfo.value' op location scope must match variable scope: #debuginfo.file<"foo.c" in ""> vs. #debuginfo.subprogram
