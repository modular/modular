...
TEST(DType, getWidthInBits) {
  ...
  EXPECT_EQ(8, DType(DType::f8).getWidthInBits());
  ...
  EXPECT_EQ(16, DType::getComplex(DType::f8).getWidthInBits());
...
TEST(DType, getAsString) {
  ...
  EXPECT_EQ("f8", DType(DType::f8).getAsString());
  ...
  EXPECT_EQ("complex<f8>", DType::getComplex(DType::f8).getAsString());
...
TEST(DType, getFromString) {
  ...
  EXPECT_EQ(DType(DType::f8), DType::getFromString("f8"));
  ...
  EXPECT_EQ(DType::getComplex(DType::f8), DType::getFromString("complex<f8>"));
