...
- **Upgraded MAX models**
  ...
  [`llama3`](https://github.com/modular/modular/tree/max/v26.4/max/pipelines/architectures/llama3)
...
- [Benchmark MAX
  Serve](https://github.com/modular/modular/tree/max/v26.4/benchmark)
...
[models on GitHub](https://github.com/modular/modular/tree/max/v26.4/max/pipelines/architectures)
now support GPUs!
...
- Expanded set of model abstractions for use by different LLM architectures:
  ...
  - Attention layers (including highly optimized implementations with
    ...
    [`AttentionWithRope`](https://github.com/modular/modular/tree/max/v26.4/max/nn/attention/attention_with_rope.py)).
  ...
  - Transformers such as
    [`Transformer` and `TransformerBlock`](https://github.com/modular/modular/tree/max/v26.4/max/nn/transformer/transformer.py).
  ...
  - Common layers such as
    [`RMSNorm`](https://github.com/modular/modular/tree/max/v26.4/max/nn/norm/rms_norm.py),
    [`Embedding`](https://github.com/modular/modular/tree/max/v26.4/max/nn/embedding.py),
    and
    [`Sequential`](https://github.com/modular/modular/tree/max/v26.4/max/nn/sequential.py).

  - KV cache management helpers, like
  `ContinuousBatchingKVCacheManager`.

  - Low-level wrappers over optimized kernels like
    [`fused_qk_ragged_rope`](https://github.com/modular/modular/tree/max/v26.4/max/nn/kernels.py).
...
3](https://github.com/modular/modular/tree/max/v26.4/max/pipelines/architectures/llama3),
...
- [Mistral
NeMo](https://github.com/modular/modular/tree/max/v26.4/max/pipelines/architectures/mistral)
(and other `MistralForCausalLM` models)

- [Replit Code V1.5
3B](https://github.com/modular/modular/tree/max/v26.4/max/pipelines/architectures/replit)
...
use. Check out the MAX repo's `nightly` branch to see the latest
[custom op examples](https://github.com/modular/modular/tree/max/v26.4/max/examples/custom_ops).
