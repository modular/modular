...
[`examples/offline-inference/basic.py`](https://github.com/modular/modular/blob/max/v26.4/max/examples/offline-inference/basic.py).
...
[`vector_addition.mojo`](https://github.com/modular/modular/blob/max/v26.4/max/examples/custom_ops/kernels/vector_addition.mojo)
and
[`top_k.mojo`](https://github.com/modular/modular/blob/max/v26.4/max/examples/custom_ops/kernels/top_k.mojo).
