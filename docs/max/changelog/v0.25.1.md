...
[`examples/offline-inference/basic.py`](https://github.com/modular/modular/blob/modular/v26.2/examples/offline-inference/basic.py).
...
a custom
op](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/add_custom.mojo).
...
[`vector_addition.mojo`](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/vector_addition.mojo)
and
[`top_k.mojo`](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/top_k.mojo).
