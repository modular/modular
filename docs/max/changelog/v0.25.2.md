...
Mojo](https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/gpu-functions),
...
- [`fused_attention`](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/fused_attention.mojo)
  demonstrates complex GPU programming using MAX abstractions for a
  practical use in AI model development.

- [`matrix_multiplication`](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/matrix_multiplication.mojo)
  includes a series of progressive optimizations for matrix multiplications
  on GPUs.

- [`histogram`](https://github.com/modular/modular/blob/modular/v26.2/examples/custom_ops/kernels/histogram.mojo)
