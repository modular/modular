...
[the source code for our CPU/GPU kernels](https://github.com/modular/modular/tree/max/v26.4/max/kernels/src).
...
GPUs.
  ...
  GitHub](https://github.com/modular/modular/tree/max/v26.4/mojo/std/src).
...
- New
  [image_pipeline example](https://github.com/modular/modular/tree/max/v26.4/max/examples/custom_ops)
...
kernels](https://github.com/modular/modular/tree/max/v26.4/max/kernels/src).
