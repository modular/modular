...
library**!
  ...
  API for writing high-performance and portable programs across CPU and GPU,
  but it's also [the source code for our CPU/GPU
  kernels](https://github.com/modular/modular/tree/modular/v26.2/max/kernels/src).
  ...
  GitHub](https://github.com/modular/modular/tree/modular/v26.2/mojo/std/src).
...
- New [image_pipeline example](https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom_ops)
