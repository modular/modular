...
- **Now accepting GPU kernel contributions**
  ...
  guide](https://github.com/modular/modular/blob/modular/v26.2/max/kernels/CONTRIBUTING.md).
...
- [Profile MAX kernel
performance](https://github.com/modular/modular/blob/modular/v26.2/max/docs/kernel-profiling.md):
...
example, with a custom `grayscale` operation written in Mojo:
  ...
  operation
  examples](https://github.com/modular/modular/tree/modular/v26.2/max/examples/pytorch_custom_ops),
