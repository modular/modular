...
- **Now accepting GPU kernel contributions**
  ...
  the
  [MAX AI kernels contributing guide](https://github.com/modular/modular/blob/max/v26.4/max/kernels/CONTRIBUTING.md).
...
- [Profile MAX kernel
performance](https://github.com/modular/modular/blob/max/v26.4/max/docs/kernel-profiling.md):
...
example, with a custom `grayscale` operation written in Mojo:
  ...
  and our
  <!-- rumdl-disable-next-line MD013 -->
  [PyTorch custom operation examples](https://github.com/modular/modular/tree/max/v26.4/max/examples/pytorch_custom_ops),
...
contributing
guide](https://github.com/modular/modular/blob/max/v26.4/max/kernels/CONTRIBUTING.md).
