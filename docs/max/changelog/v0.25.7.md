...
GitHub](https://github.com/modular/modular/tree/max/v26.4/max/python/max)!
...
source](https://github.com/modular/modular/blob/max/v26.4/max/python/max/entrypoints/pipelines.py).
...
more [in our GitHub
repo](https://github.com/modular/modular/tree/max/v26.4/max/python/max).
