...
GitHub](https://github.com/modular/modular/tree/modular/v26.2/max/python/max)!
...
source](https://github.com/modular/modular/blob/modular/v26.2/max/python/max/entrypoints/pipelines.py).
...
more [in our GitHub
repo](https://github.com/modular/modular/tree/modular/v26.2/max/python/max).
