...
[`CLAUDE.md`](https://github.com/modular/modular/blob/max/v26.5/CLAUDE.md) and
[`AGENTS.md`](https://github.com/modular/modular/blob/max/v26.5/AGENTS.md)
...
[Critical development notes](https://github.com/modular/modular/blob/max/v26.5/CLAUDE.md#critical-development-notes),
...
- **[`general_behavior_rules.mdc`](https://github.com/modular/modular/blob/max/v26.5/.cursor/rules/general_behavior_rules.mdc)**:
...
- **[`git.mdc`](https://github.com/modular/modular/blob/max/v26.5/.cursor/rules/git.mdc)**:
Best practices for Git including code organization, commit strategies,
branching models, and collaborative workflows.

- **[`max_development.mdc`](https://github.com/modular/modular/blob/max/v26.5/.cursor/rules/max_development.mdc)**:
Guidelines for MAX development covering project context, task execution, code
quality, testing practices, and documentation.

- **[`mojo.mdc`](https://github.com/modular/modular/blob/max/v26.5/.cursor/rules/mojo.mdc)**:
...
`AGENTS.md` files—our
[`AGENTS.md`](https://github.com/modular/modular/blob/max/v26.5/AGENTS.md) file is
just a symlink to the
[`CLAUDE.md`](https://github.com/modular/modular/blob/max/v26.5/CLAUDE.md) file.
