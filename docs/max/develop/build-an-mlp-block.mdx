...
github_url: https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom-graph-module/
is_tutorial: true
---
...
[`Module`](/max/api/python/generated/max.nn.Module). This block will allow
...
[`Graph`](/max/api/python/generated/max.graph.Graph) context. This provides a familiar
...
[`Module`](/max/api/python/generated/max.nn.Module) class. To create the
...
`x` (a [`TensorValue`](/max/api/python/generated/max.graph.TensorValue)) is passed through the module.
...
from std.collections.abc import Callable
...
You'll use [`Sequential`](/max/api/python/generated/max.nn.Sequential) to create a
...
iterates through `hidden_features`, appending a [`Linear`](/max/api/python/generated/max.nn.Linear)
...
you create a [`Sequential`](/max/api/python/generated/max.nn.Sequential) module with
...
[`TensorValue`](/max/api/python/generated/max.graph.TensorValue) flows through the module,
