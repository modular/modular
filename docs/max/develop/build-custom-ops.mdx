...
[`custom_ops/kernels/add_one.mojo`](https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom_ops/kernels/add_one.mojo).
...
[`custom_ops/addition.py`](https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom_ops/addition.py)
...
[`vector_addition.mojo`](https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom_ops/kernels/vector_addition.mojo)
