...
requirements](/faq/#gpu-requirements).
...
`operations/matrix_multiplication.mojo` file. Tensor types such as
...
- See the [GPU programming](https://mojolang.org/docs/manual/gpu/architecture)
