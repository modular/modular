...
The [`DType`](/max/api/python/generated/max.dtype.DType) enum in MAX provides
...
[DType API reference](/max/api/python/generated/max.dtype.DType).
...
Every tensor has a
[`dtype`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.dtype)
...
[`cast()`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.cast)
...
[`torch_dtype_to_max()`](/max/api/python/generated/max.experimental.torch.torch_dtype_to_max)
...
- [`to_numpy()`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.to_numpy):
  Convert a MAX dtype to a NumPy dtype.
- [`max_dtype_to_torch()`](/max/api/python/generated/max.experimental.torch.max_dtype_to_torch):
...
[`size_in_bytes`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.size_in_bytes)
...
- [Building graphs](/max/develop/modules): Specify
  dtypes in computation graphs.
- [Quantization](/max/graph/quantize): Quantize weights to reduce memory usage
