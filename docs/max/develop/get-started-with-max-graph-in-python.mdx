...
github_url: https://github.com/modular/modular/tree/modular/v26.2/max/examples/max-graph
is_tutorial: true
---
...
[`Graph`](/max/api/python/generated/max.graph.Graph) API with an [`ops`
...
[`Graph()`](/max/api/python/generated/max.graph.Graph) class from the MAX Python API. When
...
[`inputs`](/max/api/python/generated/max.graph.Graph#max.graph.Graph.inputs) property. This
...
[`output()`](/max/api/python/generated/max.graph.Graph#max.graph.Graph.output) method. This
...
Create an
[`InferenceSession()`](/max/api/python/generated/max.engine.InferenceSession)
...
[`input_metadata`](/max/api/python/generated/max.engine.Model#max.engine.Model.input_metadata)
property.
...
[`execute()`](/max/api/python/generated/max.engine.Model#max.engine.Model.execute) function:
...
Notice that the [`execute()`](/max/api/python/generated/max.engine.Model#max.engine.Model.execute)
function returns a list of outputs. We know we want the first element and must
assert that the type is [`Buffer`](/max/api/python/generated/max.driver.Buffer) so
...
- [MAX graph API example](https://github.com/modular/modular/tree/modular/v26.2/max/examples/max-graph)
- [MAX graph implementation of Llama3](https://github.com/modular/modular/tree/modular/v26.2/max/python/max/pipelines/architectures)
