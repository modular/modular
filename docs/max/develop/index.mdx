...
MAX doesn't support out of the box. You'll learn how to use the MAX Model API to
convert trained models from Hugging Face or PyTorch into models that MAX can
serve.
