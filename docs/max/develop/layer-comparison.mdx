...
[script](https://github.com/modular/modular/tree/max/v26.5/docs/code/develop/layer-comparison)
...
If you plan to
[contribute your model to MAX](https://github.com/modular/modular/blob/max/v26.5/max/docs/contributing-models.md),
use the in-repo
[accuracy debugging](http://github.com/modular/modular/blob/max/v26.5/max/docs/accuracy-debugging.md)
...
In the
[model](https://github.com/modular/modular/tree/max/v26.5/docs/code/develop/layer-comparison)
