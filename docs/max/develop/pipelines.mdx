...
- **Core modules**: [`Module`](/max/api/python/generated/max.experimental.nn.Module), [`Linear`](/max/api/python/generated/max.nn.Linear), [`Embedding`](/max/api/python/generated/max.experimental.nn.Embedding), [`Sequential`](/max/api/python/generated/max.experimental.nn.Sequential), [`ModuleList`](/max/api/python/generated/max.experimental.nn.ModuleList).
- **Normalization**: [`RMSNorm`](/max/api/python/generated/max.experimental.nn.norm.RMSNorm), [`GemmaRMSNorm`](/max/api/python/generated/max.experimental.nn.norm.GemmaRMSNorm).
- **Positional encodings**: [`RotaryEmbedding`](/max/api/python/generated/max.experimental.nn.rope.RotaryEmbedding), [`TransposedRotaryEmbedding`](/max/api/python/generated/max.experimental.nn.rope.TransposedRotaryEmbedding).
- **Utilities**: [`module_dataclass`](/max/api/python/generated/max.experimental.nn.module_dataclass) for creating module dataclasses.
...
The [`Module`](/max/api/python/generated/max.experimental.nn.Module) base class standardizes how
...
architecture using the [`Module`](/max/api/python/generated/max.experimental.nn.Module) class.
...
1. **Define your model**: You create a
   [`Module`](/max/api/python/generated/max.experimental.nn.Module) that defines your model
   architecture. The module's
   [`forward`](/max/api/python/generated/max.experimental.nn.Module#max.experimental.nn.Module.forward) method defines what
...
with a [`PipelineConfig`](/max/api/python/pipelines), the registry looks
...
- [`Pipeline`](/max/api/python/generated/max.interfaces.Pipeline): Abstract
  base class for all pipelines. Defines `execute()` and `release()` methods that
  all pipeline implementations must provide.

- [`PipelineInputs`](/max/api/python/generated/max.interfaces.PipelineInputs):
  Base class for inputs to a pipeline, such as text generation requests or
  embeddings requests.

- [`PipelineOutput`](/max/api/python/generated/max.interfaces.PipelineOutput):
  Protocol for pipeline outputs. Must implement `is_done` to signal when
  generation is complete.

- [`PipelineTokenizer`](/max/api/python/generated/max.interfaces.PipelineTokenizer):
...
[`TextGenerationInputs`](/max/api/python/generated/max.interfaces.TextGenerationInputs)
and
[`TextGenerationOutput`](/max/api/python/generated/max.interfaces.TextGenerationOutput)
...
[custom-models example](https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom-models)
