...
and [`max.pipelines.kv_cache`](/api/python/pipelines.kv_cache).

### Neural network module

The [`max.nn`](/api/python/nn) (neural network) package provides reusable
...
- **Core modules**:
  [`Module`](/api/python/generated/max.experimental.nn.Module),
  [`Linear`](/api/python/generated/max.nn.Linear),
  [`Embedding`](/api/python/generated/max.experimental.nn.Embedding),
  [`Sequential`](/api/python/generated/max.experimental.nn.Sequential),
  [`ModuleList`](/api/python/generated/max.experimental.nn.ModuleList).
- **Normalization**:
  [`RMSNorm`](/api/python/generated/max.experimental.nn.norm.RMSNorm),
  [`GemmaRMSNorm`](/api/python/generated/max.experimental.nn.norm.GemmaRMSNorm).
- **Positional encodings**:
  [`RotaryEmbedding`](/api/python/generated/max.experimental.nn.rope.RotaryEmbedding),
  [`TransposedRotaryEmbedding`](/api/python/generated/max.experimental.nn.rope.TransposedRotaryEmbedding).
- **Utilities**:
  [`module_dataclass`](/api/python/generated/max.experimental.nn.module_dataclass)
...
The [`Module`](/api/python/generated/max.experimental.nn.Module) base class
...
[`Module`](/api/python/generated/max.experimental.nn.Module) class. MAX then
...
1. **Define your model**: You create a
   [`Module`](/api/python/generated/max.experimental.nn.Module) that defines
...
[`max.nn`](/api/python/nn) to define model architectures, let MAX handle
...
Phi-3; see the
[`llama3` architecture](https://github.com/modular/modular/tree/max/v26.5/max/python/max/pipelines/architectures/llama3)
