...
of your [model bring-up workflow](/max/develop/model-bringup-workflow/) and
...
in [`llama3/model_config.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/llama3/model_config.py)
...
[`qwen3/model_config.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/qwen3/model_config.py)
...
[`deepseekV3/model_config.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/deepseekV3/model_config.py)
...
[MAX modules](/max/develop/modules/):
...
[`llama3/model_config.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/llama3/model_config.py):
...
[`qwen3/layers/attention.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/qwen3/layers/attention.py)
...
module in [`deepseekV3/deepseekV3.py`](https://github.com/modular/modular/blob/max/v26.4/max/python/max/pipelines/architectures/deepseekV3/deepseekV3.py):
...
- [Quantization](/max/graph/quantize/): Work with quantized weight encodings
