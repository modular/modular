...
github_url: https://github.com/modular/modular/tree/modular/v26.2/max/examples/custom-models
is_tutorial: true
---
...
architectures](https://github.com/modular/modular/tree/modular/v26.2/max/python/max/pipelines/architectures)
