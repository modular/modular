...
[Python serving library](https://github.com/modular/modular/tree/max/v26.4/max/python/max/serve),
[MAX model architectures](https://github.com/modular/modular/tree/max/v26.4/max/python/max/pipelines/architectures),
and
[GPU kernels](https://github.com/modular/modular/tree/max/v26.4/max/kernels/src/nn).
