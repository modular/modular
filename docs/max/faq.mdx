---
title: FAQ
description: Answers to various questions about the MAX framework.
---
...
You can install `max` on Mac and Linux operating systems.
...
The MAX framework supports both CPUs and GPUs, so you don't always need a
...
check out our
[tutorial to deploy a model to the cloud](/serve/local-to-cloud/).
...
precision](/develop/dtypes#numerical-precision).
...
read the [packages guide](/packages).
