...
our [Python serving library](https://github.com/modular/modular/tree/modular/v26.2/max/python/max/serve),
[MAX model architectures](https://github.com/modular/modular/tree/modular/v26.2/max/python/max/pipelines/architectures),
and [GPU kernels](https://github.com/modular/modular/tree/modular/v26.2/max/kernels/src/nn).
