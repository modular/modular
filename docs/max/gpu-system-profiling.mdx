...
[Nsight Compute](https://github.com/modular/modular/blob/max/v26.5/max/docs/kernel-profiling.md),
...
Compute](https://github.com/modular/modular/blob/max/v26.5/max/docs/kernel-profiling.md):
