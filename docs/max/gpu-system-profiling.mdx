...
[Nsight Compute](https://github.com/modular/modular/blob/max/v26.4/max/docs/kernel-profiling.md),
...
For a one-command introduction to profiling, [`max generate`](/max/cli/generate)
and [`max benchmark`](/max/cli/benchmark) accept a `--profile` flag. When
...
Compute](https://github.com/modular/modular/blob/max/v26.4/max/docs/kernel-profiling.md):
