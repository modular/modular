...
Compute](https://github.com/modular/modular/blob/modular/v26.2/max/docs/kernel-profiling.md),
or our purpose-built [`kbench`
tool](https://github.com/modular/modular/tree/modular/v26.2/max/kernels/benchmarks/autotune#readme)
...
You should adjust `--cpunodebind` and `--membind` based on your system topology—use
