...
github_url: https://github.com/modular/modular/tree/max/v26.5/max/examples/gpu-block-and-warp
---
...
- [MAX accelerator library](https://github.com/modular/modular/tree/max/v26.5/max/kernels):
