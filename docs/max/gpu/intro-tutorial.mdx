...
github_url: https://github.com/modular/modular/tree/max/v26.5/max/examples/gpu-intro
...
GitHub](https://github.com/modular/modular/tree/max/v26.5/max/examples/gpu-intro).
See [GPU
...
<ListingCards>
  ...
  <ListingCard title="GPU code examples"
    url="https://github.com/modular/modular/tree/max/v26.5/max/examples/gpu-functions"
