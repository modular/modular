...
[quantization](/max/api/python/generated/max.graph.quantization.QuantizationEncoding)
documentation.

## Understanding quantization

[Quantization](https://handbook.modular.com/model-preparation/llm-quantization/)
reduces the numeric precision of model weights to decrease memory usage and
increase inference speed. For example, models originally trained with `float32`
weights can be represented using lower precision types like `int8` or `int4`,
...
documentation or the [MAX Serve API reference](/max/rest-api/).
...
[`Q4_0`](/max/api/python/generated/max.graph.quantization.QuantizationEncoding#max.graph.quantization.QuantizationEncoding.Q4_0),
[`Q4_K`](/max/api/python/generated/max.graph.quantization.QuantizationEncoding#max.graph.quantization.QuantizationEncoding.Q4_K),
...
2. Replace the standard matrix multiplication `(@)` with the
   [`qmatmul`](/max/api/python/graph.ops#max.graph.ops.qmatmul) operation.
...
- [Q5_K](/max/api/python/generated/max.graph.quantization.QuantizationEncoding#max.graph.quantization.QuantizationEncoding.Q5_K):
  5-bit quantization with K-means clustering
- [Q6_K](/max/api/python/generated/max.graph.quantization.QuantizationEncoding#max.graph.quantization.QuantizationEncoding.Q6_K):
  6-bit quantization with K-means clustering
- [GPTQ](/max/api/python/generated/max.graph.quantization.QuantizationEncoding#max.graph.quantization.QuantizationEncoding.GPTQ):
...
The [`qmatmul`](/max/api/python/graph.ops#max.graph.ops.qmatmul) operation
...
[Map weight names](/max/develop/model-bringup-workflow#fp8-and-fp4-checkpoints)
