...
- [Image and video to text](/max/inference/image-to-text): Use the MAX chat
  completions endpoint with image or video input to generate descriptions and
  answer questions about visual content.
- [Structured output](/max/serve/structured-output): Enable structured output
  with your GenAI deployments for predictable responses.
- [Deploy MAX on GPU with self-hosted endpoints](/max/deploy/local-to-cloud):
