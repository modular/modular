...
The MAX [`v1/responses`](/max/rest-api/#POST/v1/responses) endpoint provides a
...
[`/v1/responses` API reference](/max/rest-api/#POST/v1/responses).
...
GPU](/max/packages#gpu-compatibility) with sufficient GPU RAM. Video generation
...
<InstallModular folder="video-generation-quickstart" />
...
- [Image generation](/max/inference/image-generation): Generate images from
