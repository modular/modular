...
github_url: https://github.com/modular/modular/tree/max/v26.5/max/examples/embedding-knowledge-base/
---
...
MAX supports the
[`v1/embeddings`](/rest-api/create-embeddings/) endpoint, which is
