...
[llguidance](https://github.com/guidance-ai/llguidance) as a backend. Structured
output, also sometimes referred to as constrained decoding, allows users to
enforce specific output formats, ensuring structured and predictable responses
from a model.
...
Both the
[`/chat/completions`](/rest-api/#POST/v1/chat/completions) and
[`/completions`](/rest-api/#POST/v1/completions) API endpoints are
