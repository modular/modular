...
The [`v1/chat/completions`](/rest-api/#POST/v1/chat/completions)
...
The [`v1/completions`](/rest-api/#POST/v1/completions) endpoint is
...
The [`v1/completions`](/rest-api/#POST/v1/completions) endpoint
