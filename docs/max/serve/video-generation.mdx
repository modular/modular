...
[`v1/responses`](/rest-api/#POST/v1/responses) endpoint to generate
videos from text prompts or animate existing images.

## Endpoint

The MAX [`v1/responses`](/rest-api/#POST/v1/responses) endpoint provides a
...
[`provider_options`](/rest-api/#POST/v1/responses.body.provider_options).
...
[`/v1/responses` API reference](/rest-api/#POST/v1/responses).
