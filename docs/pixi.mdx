...
All our
[GitHub code examples](https://github.com/modular/modular/tree/max/v26.4/max/examples)
include a `pixi.toml` file. This file configures the environment to make sure we
all use the same packages and get the same results—you just need to install
`pixi`.
