...
- [Get started with MAX Graph in Python](/max/develop/graph/)
...
- The [`max.graph`](/max/api/python/graph/) APIs now include preliminary support
  for symbolic algebraic expressions using
  [`AlgebraicDim`](/max/api/python/generated/max.graph.AlgebraicDim/), enabling
...
- [`Graph.add_weight()`](/max/api/python/generated/max.graph.Graph/#max.graph.Graph.add_weight)
  now accepts
  [`Weight`](/max/api/python/generated/max.graph.Weight/#max.graph.Weight) and
  returns [`TensorValue`](/max/api/python/generated/max.graph.TensorValue/).
  [`Weight`](/max/api/python/generated/max.graph.Weight/#max.graph.Weight) is
...
[experiment with it now by following the graph overview guide](/max/develop/graph/).
