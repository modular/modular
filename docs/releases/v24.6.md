...
- **Upgraded MAX models**
  ...
  [`llama3`](https://github.com/modular/modular/tree/max/v26.5/max/pipelines/architectures/llama3)
...
- [Benchmark MAX
  Serve](https://github.com/modular/modular/tree/max/v26.5/benchmark)
...
[models on GitHub](https://github.com/modular/modular/tree/max/v26.5/max/pipelines/architectures)
now support GPUs!
...
- Expanded set of model abstractions for use by different LLM architectures:
  - Attention layers (including highly optimized implementations with
    ...
    [`AttentionWithRope`](https://github.com/modular/modular/tree/max/v26.5/max/nn/attention/attention_with_rope.py)).
  ...
  - Transformers such as
    [`Transformer` and `TransformerBlock`](https://github.com/modular/modular/tree/max/v26.5/max/nn/transformer/transformer.py).
  ...
  - Common layers such as
    [`RMSNorm`](https://github.com/modular/modular/tree/max/v26.5/max/nn/norm/rms_norm.py),
    [`Embedding`](https://github.com/modular/modular/tree/max/v26.5/max/nn/embedding.py),
    and
    [`Sequential`](https://github.com/modular/modular/tree/max/v26.5/max/nn/sequential.py).

  - KV cache management helpers, like
    `ContinuousBatchingKVCacheManager`.

  - Low-level wrappers over optimized kernels like
    [`fused_qk_ragged_rope`](https://github.com/modular/modular/tree/max/v26.5/max/nn/kernels.py).
...
- Significant performance upgrades for
  [Llama 3](https://github.com/modular/modular/tree/max/v26.5/max/pipelines/architectures/llama3),
...
- [Mistral NeMo](https://github.com/modular/modular/tree/max/v26.5/max/pipelines/architectures/mistral)
  (and other `MistralForCausalLM` models)

- [Replit Code V1.5 3B](https://github.com/modular/modular/tree/max/v26.5/max/pipelines/architectures/replit)
...
examples](https://github.com/modular/modular/tree/max/v26.5/max/examples/custom_ops).
