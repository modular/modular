...
[`vector_addition.mojo`](https://github.com/modular/modular/blob/max/v26.5/max/examples/custom_ops/kernels/vector_addition.mojo)
and
[`top_k.mojo`](https://github.com/modular/modular/blob/max/v26.5/max/examples/custom_ops/kernels/top_k.mojo).
