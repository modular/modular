...
[the source code for our CPU/GPU kernels](https://github.com/modular/modular/tree/max/v26.5/max/kernels/src).
...
GitHub](https://github.com/modular/modular/tree/max/v26.5/mojo/std/src).
...
- New
  [image_pipeline example](https://github.com/modular/modular/tree/max/v26.5/max/examples/custom_ops)
...
- We've also open sourced [all our MAX AI
  kernels](https://github.com/modular/modular/tree/max/v26.5/max/kernels/src).
