...
- Swapped the order of the `dtype` and `shape` fields of
  [`driver.Tensor`](/max/api/python/driver/#max.driver.Tensor). Previously, the
...
- Made the default behavior of
  [`Weight`](/max/api/python/generated/max.graph.Weight/) as expecting the
...
- Removed some functionality from
  [`tensor.Tensor`](/max/api/kernels/extensibility/tensor_arg_traits/Tensor/):
...
- You can now pass Mojo source package paths as
  [`Graph`](/max/api/python/generated/max.graph.Graph/) custom extensions. The
