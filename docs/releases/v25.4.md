...
- **Now accepting GPU kernel contributions**
  ...
  the
  [MAX AI kernels contributing guide](https://github.com/modular/modular/blob/max/v26.5/max/kernels/CONTRIBUTING.md).
...
- [Profile MAX kernel performance](https://github.com/modular/modular/blob/max/v26.5/max/docs/kernel-profiling.md):
...
- Following our [previous deprecation](/releases/#25-3-engine-mojo-api) of
...
- Added the [`max.torch`](/api/python/torch/) module with the
  ...
  [PyTorch custom operation examples](https://github.com/modular/modular/tree/max/v26.5/max/examples/pytorch_custom_ops),
