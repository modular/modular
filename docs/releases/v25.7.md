...
- The MAX Python API is now [fully open-sourced on
  GitHub](https://github.com/modular/modular/tree/max/v26.5/max/python/max)!
...
- All MAX Python API modules are now **open-sourced**. In addition to those
  ...
  more [in our GitHub
  repo](https://github.com/modular/modular/tree/max/v26.5/max/python/max).
...
- Added more APIs for text-to-speech (TTS) models such as
  [`AudioGenerationInputs`](/api/python/interfaces/#max.interfaces.AudioGenerationInputs)
  and
