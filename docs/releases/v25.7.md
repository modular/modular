...
- New [`RequestID`](/api/python/generated/max.pipelines.request.RequestID/)
  class replaces previous type alias to provide better type safety and
  consistency across the API.

- Removed `InputContext` and replaced it with the modality-output specific
  `TextGenerationContext` and
  [`EmbeddingsContext`](/api/python/generated/max.pipelines.modeling.types.EmbeddingsContext/).

- Added
  [`ImageMetadata`](/api/python/generated/max.pipelines.context.ImageMetadata/)
  and `VLMTextGenerationContext`.
