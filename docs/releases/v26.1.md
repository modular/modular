...
The eager-style
[`Tensor`](/max/api/python/generated/max.experimental.tensor.Tensor/#max.experimental.tensor.Tensor)
and [`Module`](/max/api/python/generated/max.nn.Module/) APIs are now the
primary API for model development, providing a PyTorch-like development
experience:
...
- Renamed `max.driver.Tensor` to
  [`max.driver.Buffer`](/max/api/python/driver/#max.driver.Buffer) to clarify
  that it represents a low-level memory buffer, not a tensor. The
  [`max.tensor.Tensor`](/max/api/python/generated/max.experimental.tensor.Tensor/#max.experimental.tensor.Tensor)
...
- Added
  [`TokenBuffer`](/max/api/python/generated/max.pipelines.context.TokenBuffer/#max.pipelines.context.TokenBuffer)
