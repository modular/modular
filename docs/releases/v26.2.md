...
- MAX now supports **image generation** with FLUX diffusion models
  ...
  [image generation guide](/max/inference/image-generation/) to get started.
...
- Refactored the [MAX Python API reference](/max/api/python/) into a flat list
...
- Added [Basic operations](/max/develop/basic-ops/) to the model developer
...
- Added [Model pipeline](/max/develop/pipelines/) to the model developer
...
- Added [Image generation](/max/inference/image-generation/) to the inference
...
- Added the [Environment variables](/max/environment-variables/) reference,
...
- Added image generation support via a new `/v1/responses` endpoint implementing
  ...
  [image generation guide](/max/inference/image-generation/).
