...
the
[custom model architectures tutorial](https://docs.modular.com/develop/serve-custom-model-architectures/).
...
serve`](https://docs.modular.com/cli/serve) except it runs directly from
your local code.
...
- Check out these other docs:
  ...
  - [GPU profiling with Nsight Systems](https://docs.modular.com/gpu-system-profiling)
