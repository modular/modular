...
from ._trait import HalPluginHooks
from ._overlay import PLUGINS
from .selector import get_plugin_index
from std.sys.info import _TargetType

comptime CurrentHalPlugin: HalPluginHooks = PLUGINS._get_type_at_index[
    get_plugin_index()
]
"""The active `PluginHooks`."""

comptime HalPluginForTarget[Target: _TargetType] = PLUGINS._get_type_at_index[
