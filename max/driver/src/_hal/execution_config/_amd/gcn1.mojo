...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for AMD GCN 1st generation (Southern Islands)
GPUs: Tahiti (gfx600), Pitcairn/Verde (gfx601), Hainan/Oland (gfx602)."""
...
struct GCN1ExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
