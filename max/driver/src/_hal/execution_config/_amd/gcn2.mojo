...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for AMD GCN 2nd generation (Sea Islands)
GPUs: Kaveri (gfx700), Hawaii (gfx701/gfx702, e.g. FirePro W9100, Radeon R9
290), Kabini/Mullins (gfx703), Bonaire (gfx704, e.g. Radeon HD 7790)."""
...
struct GCN2ExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
