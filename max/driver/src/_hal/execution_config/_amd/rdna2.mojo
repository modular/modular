...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for AMD RDNA2 GPUs (Radeon RX 6900 XT,
RX 6800 XT, RX 6800, Radeon PRO W6800, Radeon PRO V620, RX 6700 XT)."""
...
struct RDNA2ExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
