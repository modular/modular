...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for AMD RDNA3 GPUs (Radeon PRO W7900,
Radeon PRO W7800, RX 7900 XTX, RX 7900 XT, RX 7900 GRE, RX 7800 XT,
RX 7700 XT, RX 7600, and RDNA3 APUs such as Radeon 890M/860M)."""
...
struct RDNA3ExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
