...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for the NVIDIA A100 (Ampere datacenter) GPU."""
...
struct A100ExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
    ...
    """Describes the execution configuration of a GPU kernel launch on the NVIDIA A100.
    """
