...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for NVIDIA Ada consumer GPUs (RTX 4090, RTX 4090M)."""
...
struct AdaConsumerExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
    ...
    """Describes the execution configuration of a GPU kernel launch on NVIDIA Ada Lovelace consumer GPUs.
    """
