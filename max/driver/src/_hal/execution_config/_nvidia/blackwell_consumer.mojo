...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for NVIDIA Blackwell consumer GPUs (RTX 5090)."""
...
struct BlackwellConsumerExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
    ...
    NVIDIA Blackwell consumer GPUs."""

    var _base: _BaseCudaExecutionConfiguration

    comptime InnerConfigOrigin[origin: Origin] = origin._get_owned_interior[
        "_base"
    ]
