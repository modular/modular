...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for NVIDIA Maxwell consumer GPUs (GTX 970)."""
...
struct MaxwellConsumerExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
    ...
    """Describes the execution configuration of a GPU kernel launch on an
    NVIDIA Maxwell consumer GPU."""
