...
# ===----------------------------------------------------------------------=== #
"""Execution config placeholder for NVIDIA Pascal consumer GPUs (GTX 1060, GTX 1080 Ti)."""
...
struct PascalConsumerExecutionConfiguration(
    BlockExecutionConfig,
    ConstantMemoryMappingExecutionConfig,
    Copyable,
    ExecutionConfig,
    ...
    """Describes the execution configuration of a GPU kernel launch on NVIDIA Pascal consumer GPUs.
    """
