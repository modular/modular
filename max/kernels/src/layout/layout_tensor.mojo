...
struct LayoutTensor[
    ...
    *,
    ...
    # FIXME: This overload shouldn't be necessary but the parser doesn't infer
    # immutable origins from mutable ones correctly for types with default
    # parameters
    @doc_private
    @implicit
    @always_inline("nodebug")
