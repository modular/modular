...
fn _matmul_Q4_K_tile[
    ...
    elementwise_lambda_fn: OptionalReg[elementwise_epilogue_type] = None,
](    a_ptr: UnsafePointer[mut=True, _block_Q8_K_packed[_block_Q4_K.group_size], ...],
    b_ptr: UnsafePointer[mut=True, _block_Q4_K_packed[], ...],
    b_q_scales_and_mins_buf: UnsafePointer[mut=True, UInt8, ...],
    c_ptr: UnsafePointer[mut=True, Float32, ...],
    N: Int,
    accumulate: Bool,
    m: Int,
