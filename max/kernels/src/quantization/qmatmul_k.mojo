...
struct _packed_bit_array[bit_width: Int, block_m: Int, block_n: Int]:
    ...
    @always_inline
    fn _unpack_int4(self, var dst_ptr: UnsafePointer[UInt8, mut=True, **_]):
        constrained[bit_width == 4]()
        constrained[(block_m % (2 * Self._tuple_width)) == 0]()
    ...
    fn _unpack_int6[
        zero_point: UInt8
    ](self, var dst_ptr: UnsafePointer[UInt8, mut=True, **_]):
        constrained[bit_width == 6]()
        constrained[(block_m % (4 * Self._tuple_width)) == 0]()
...
fn _matmul_group_unpacked[
    ...
    mut b_q_bits_ptr: UnsafePointer[UInt8, mut=False, origin=b_origin],
    mut c_int32_group: _Accumulator[DType.int32, tile_m, tile_n, simd_width],
):
...
fn _matmul_Q4_K_columns[
    ...
    b_ptr: UnsafePointer[_block_Q4_K_packed[], mut=False, origin=b_origin],
    var c_ptr: UnsafePointer[Float32, mut=True, origin=c_origin],
    M: Int,
    N: Int,
    accumulate: Bool,
    n: Int,
    ...
    @always_inline
    fn process_rows[tile_m: Int](m: Int):
        var b_q_bits_ptr = b_q_bits.origin_cast[False]()
...
fn _matmul_Q6_K_columns[
    ...
    b_ptr: UnsafePointer[_block_Q6_K_packed[], mut=False, origin=b_origin],
    var c_ptr: UnsafePointer[Float32, mut=True, origin=c_origin],
    M: Int,
    N: Int,
    accumulate: Bool,
...
fn _matmul_Qb_K[
    ...
    columns_fn: fn[
        ...
        b_ptr: UnsafePointer[b_type, mut=False, origin=b_origin],
        var c_ptr: UnsafePointer[Float32, mut=True, origin=c_origin],
        M: Int,
        N: Int,
        accumulate: Bool,
    ...
    *,
    ...
    fn task_func(task_id: Int):
        ...
        var a_packed_ptr = a_packed_base_ptr.origin_cast[False]()
