...
fn run_layer_norm_gated_gpu[
...
](shape: IndexList[rank], ctx: DeviceContext, rtol: Float64 = 0.01,) raises:
    ...
    fn gpu_output_fn[
        ...
        var idx = result_gpu_buf.runtime_layout(
            RuntimeTuple[fill_like(result_gpu_buf.layout.shape, UNKNOWN_VALUE)](
                coords
            )
        )
