...
def test_kpool_compress[
    ...
    comptime kernel = kpool_compress_kernel[
        ...
        out_tile.LayoutType,
        out_tile.origin,
        type_of(k_tile.as_immut()).Engine,
        type_of(gate_tile.as_immut()).Engine,
        type_of(ape_tile.as_immut()).Engine,
        type_of(iro_tile.as_immut()).Engine,
        type_of(pro_tile.as_immut()).Engine,
        type_of(clen_tile.as_immut()).Engine,
        out_tile.Engine,
        head_dim,
        kpool,
    ]
...
def test_decode_writer_matches_prefill_writer[
    ...
    comptime tail_kernel = kpool_tail_update_kernel[
        ...
        closed_tile.Engine,
        type_of(step_k_tile.as_immut()).Engine,
        type_of(step_gate_tile.as_immut()).Engine,
        type_of(ape_tile.as_immut()).Engine,
        type_of(pos_tile.as_immut()).Engine,
        type_of(slot_tile.as_immut()).Engine,
        head_dim,
        kpool,
    ]
...
def _drive_two_requests[
    ...
    comptime kern = kpool_tail_update_kernel[
        ...
        pooled_t.Engine,
        closed_t.Engine,
        type_of(k_t.as_immut()).Engine,
        type_of(g_t.as_immut()).Engine,
        type_of(ape_t).Engine,
        type_of(pos_t.as_immut()).Engine,
        type_of(slot_t.as_immut()).Engine,
        head_dim,
        kpool,
    ]
...
def test_expand_topk[
    ...
    comptime kernel = kpool_expand_topk_kernel[
        ...
        type_of(clen_tile.as_immut()).LayoutType,
        out_tile.Engine,
        type_of(pool_tile.as_immut()).Engine,
        type_of(iro_tile.as_immut()).Engine,
        type_of(clen_tile.as_immut()).Engine,
        kpool,
        pool_topk,
...
def _seed_chunk[
    ...
    comptime kern = kpool_seed_tail_kernel[
        ...
        type_of(k_t.as_immut()).Engine,
        type_of(g_t.as_immut()).Engine,
        type_of(iro_t.as_immut()).Engine,
        type_of(clen_t.as_immut()).Engine,
        type_of(slot_t.as_immut()).Engine,
        head_dim,
        kpool,
    ]
