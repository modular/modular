...
def _unpack_code(packed: HostBuffer[DType.uint8], base: Int, i: Int) -> UInt8:
...
def _run_case[
    ...
    var out_d = ctx.enqueue_create_buffer[DType.uint8](total_tokens * out_bytes)
    ...
    var out_h = ctx.enqueue_create_host_buffer[DType.uint8](
        total_tokens * out_bytes
    )
