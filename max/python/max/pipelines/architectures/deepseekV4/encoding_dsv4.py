...
# Vendored by Modular, verbatim below this header, from
# huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731 at revision
# 7872f01b1d1fe23eabc4c98b48bffcef5a386062, file encoding/encoding_dsv4.py.
# The checkpoint ships no chat template; this is its reference prompt format.
# Kept unformatted and excluded from ruff so a re-vendor diffs cleanly; the
# one mypy finding (an unannotated empty list) is silenced here, not edited.
