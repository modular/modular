...
"""Gemma3 text encoder transformer without KV cache dependency.
...
if TYPE_CHECKING:
    from .model_config import Gemma3TextEncoderConfigBase


class Gemma3MLP(Module[[Tensor], Tensor]):
    """Gemma3 MLP with SiLU gate activation."""
...
class Gemma3TextEncoderTransformer(Module[..., tuple[Tensor, ...]]):
    """Gemma3 text encoder transformer without KV cache dependency.
    ...
    def __init__(self, config: Gemma3TextEncoderConfigBase) -> None:
        super().__init__()
