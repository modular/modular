...
"""Configuration for Gemma3 text encoder."""
...
class Gemma3TextEncoderConfigBase(MAXModelConfigBase):
    """Base configuration for Gemma3 text encoder."""
...
class Gemma3TextEncoderConfig(Gemma3TextEncoderConfigBase):
    @staticmethod
    def generate(
        config_dict: dict[str, Any],
        encoding: SupportedEncoding,
        devices: list[Device],
    ) -> Gemma3TextEncoderConfigBase:
        ...
        Returns:
            Gemma3TextEncoderConfigBase instance.
        """
        ...
        for key, value in text_config.items():
            ...
            if mapped_key in Gemma3TextEncoderConfigBase.__annotations__:
        ...
        return Gemma3TextEncoderConfigBase(**init_dict)
