...
# already implementing Gemma3
# class Gemma3MultiModalTokenizer(TextAndVisionTokenizer):
#     """Gemma3MultiModal-specific tokenizer. This class has new_context modified to use the transformers tokenizer and processor.
...
#         # Special tokens for Gemma3 multimodal
#         self.boi_token_id = config.boi_token_index
#         self.eoi_token_id = config.eoi_token_index
