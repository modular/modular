...
if ENABLE_NEW_IMPL:
    from .model import Gemma3_MultiModalModelV3
else:
    from . import weight_adapters_legacy as weight_adapters
    from .model_legacy import Gemma3_MultiModalModelLegacyV3
...
if ENABLE_NEW_IMPL:
    gemma3_multimodal_arch_v3 = SupportedArchitecture(
        ...
        pipeline_model=Gemma3_MultiModalModelV3,
    ...
    gemma3_multimodal_arch_v3 = SupportedArchitecture(
        ...
        pipeline_model=Gemma3_MultiModalModelLegacyV3,
        task=PipelineTask.TEXT_GENERATION,
