...
class InklingBatchProcessor(
    SingleReplicaRaggedBatchProcessor[TextContext, InklingInputs]
):
    """Ragged batching with Inkling's convolution slots."""
    ...
    def bind_runtime_state(
        self, state_cache: InklingConvStateCache | None
    ) -> None:
