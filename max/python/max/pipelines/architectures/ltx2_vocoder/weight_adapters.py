...
# ===----------------------------------------------------------------------=== #
"""Weight adapters for LTX2Vocoder models."""
...
def convert_safetensor_state_dict(
    ...
    """Ensure shared LTX2Vocoder embeddings are available under MAX expected names.

    MAX's LTX2Vocoder graph registers both `shared.weight` and
    ...
    if shared_weight is None and encoder_weight is None:
        raise ValueError(
            "Missing LTX2Vocoder embedding weights. Expected one of "
