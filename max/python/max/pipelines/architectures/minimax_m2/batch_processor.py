...
# ===----------------------------------------------------------------------=== #
"""Input batching for MiniMax-M2 pipeline models."""
...
if TYPE_CHECKING:
    from .model import MiniMaxM2Inputs


class MiniMaxM2BatchProcessor(Llama3EpBatchProcessor):
    """Ragged batching with DP attention and EP MoE for MiniMax-M2."""
