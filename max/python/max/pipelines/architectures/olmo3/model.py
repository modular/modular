...
class Olmo3Model(PipelineModel[TextContext], KVCacheMixin):
    ...
    def get_kv_params(
        ...
        Delegates to the :obj:`Olmo3Config.get_kv_params` static method.
        ...
        """
        return Olmo3Config.get_kv_params(
            huggingface_config,
            pipeline_config,
            devices,
            kv_cache_config,
    ...
    def get_num_layers(cls, huggingface_config: AutoConfig) -> int:
        ...
        Delegates to the :obj:`Olmo3Config.get_num_layers` static method.
        ...
        """
        return Olmo3Config.get_num_layers(huggingface_config)
    ...
    def load_model(self) -> Callable[..., Any]:
        ...
        model_config = Olmo3Config.generate(
            pipeline_config=self.pipeline_config,
            huggingface_config=huggingface_config,
