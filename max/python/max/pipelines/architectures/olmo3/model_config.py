...
class Olmo3Config(MAXModelConfigBase):
    ...
    def generate(
        ...
        """Generates an Olmo3Config instance from various configuration sources.
        ...
        :obj:`Olmo3Config` object for use within the MAX Engine pipeline.
        ...
        Returns:
            An initialized :obj:`Olmo3Config` instance.
        """
        ...
        layer_types = getattr(
            ...
            * (huggingface_config.num_hidden_layers // 4)
            + ["full_attention"] * (huggingface_config.num_hidden_layers % 4),
        )
        ...
        use_qk_norm = getattr(huggingface_config, "use_qk_norm", False)
        qk_norm_eps = getattr(huggingface_config, "qk_norm_eps", 1e-6)
        ...
        return Olmo3Config(
            ...
            kv_params=Olmo3Config.get_kv_params(
