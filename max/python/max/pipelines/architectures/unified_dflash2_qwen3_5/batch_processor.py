...
# ===----------------------------------------------------------------------=== #
"""Input batching for the fused Qwen3.5 DFlash2 graph -- export only."""
...
class UnifiedDflash2Qwen3_5BatchProcessor(Qwen3_5BatchProcessor):
    ...
    def prepare_initial_token_inputs(
        ...
        raise NotImplementedError(
            ...
            " this checkpoint from MAX, drop --speculative-method and it runs"
            " unspeculated on the base Qwen3_5 architecture."
        )
