...
The [Modular](https://docs.modular.com/intro) platform, powered by the MAX
...
compatibility, see [MAX containers](https://docs.modular.com/container) in
...
support](https://docs.modular.com/model-formats) documentation.
