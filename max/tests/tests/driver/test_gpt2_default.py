...
def _module_weights(
    ...
    # draw; unseeded draws made this suite's HAL twin flake in CI. Seeding per
    # build (not per module import) keeps each test's weights independent of
    # test ordering and `-k` filtering.
