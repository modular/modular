...
- `UnsafePointer` has been renamed to
  ...
  *Note*: `LegacyUnsafePointer` and `LegacyOpaquePointer` will eventually be
  ...
  [UnsafePointer v2 proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/unsafe-pointer-v2.md#migration-guide-from-legacyunsafepointer-to-the-new-unsafepointer).
