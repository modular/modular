...
Using this version of the decorator requires some knowledge of the Mojo compiler's
internals. Using it outside of the standard library is not recommended. Use the
standard `@always_inline` decorator or the `"nodebug"` version, instead.
...
[the `@always_inline("builtin") proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/always_inline_builtin.md).
