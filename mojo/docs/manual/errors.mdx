...
[`error_interaction.mojo`](https://github.com/modular/modular/blob/modular/v26.2/mojo/docs/code/manual/errors/error_interaction.mojo).
...
[`resource_guard.mojo`](https://github.com/modular/modular/blob/modular/v26.2/mojo/docs/code/manual/errors/resource_guard.mojo).
