...
[`error_interaction.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/docs/code/manual/errors/error_interaction.mojo).
...
[`resource_guard.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/docs/code/manual/errors/resource_guard.mojo).
