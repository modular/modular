...
The [`@fieldwise_init`](/docs/manual/decorators/fieldwise-init) decorator
...
If your error type implements the [`Writable`](/docs/std/format/Writable) trait,
...
[reflection](/docs/manual/reflection/) to inspect the error
