...
[`ImplicitlyCopyable`](/docs/std/builtin/value/ImplicitlyCopyable/) requires the
transfer sigil to re-raise.
...
[GPU fundamentals](https://docs.modular.com/gpu/fundamentals/).
...
[`error_interaction.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/docs/code/manual/errors/error_interaction.mojo).
...
[`resource_guard.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/docs/code/manual/errors/resource_guard.mojo).
