...
github_url: https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/examples/gpu-intro
...
finished code, you can
[get it on GitHub](https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/examples/gpu-intro).
...
<ListingCards>
  ...
  <ListingCard title="GPU code examples"
    url="https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/examples/gpu-functions"
