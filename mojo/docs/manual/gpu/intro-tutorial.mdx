...
github_url: https://github.com/modular/modular/tree/modular/v26.1/mojo/examples/gpu-intro
...
GitHub](https://github.com/modular/modular/tree/modular/v26.1/mojo/examples/gpu-intro).
...
export const Examples = {
    ...
    metadata: {
        permalink: "https://github.com/modular/modular/tree/modular/v26.1/mojo/examples/gpu-functions"
    }
};
