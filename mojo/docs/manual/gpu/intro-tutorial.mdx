...
github_url: https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/gpu-intro
...
GitHub](https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/gpu-intro).
...
<ListingCards>
  ...
  <ListingCard title="GPU code examples"
    url="https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/gpu-functions"
