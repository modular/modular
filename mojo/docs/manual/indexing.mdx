...
The `__getitem__` method enables reading a single value from a `Matrix` instance
via subscript. Supply the coordinates using index notation with square bracket
