...
5. Install Mojo:
    ...
    <Tabs groupId="release">
      <TabItem value="nightly" label="Nightly">
        ...
        ```sh
        conda install -c conda-forge \
          -c https://conda.modular.com/max/ "mojo==0.26.1"
        ```
...
The
[`examples/mojo/`](https://github.com/modular/modular/tree/modular/v26.1/mojo/examples)
...
- [`mojo` Python
  package](https://github.com/modular/modular/tree/modular/v26.1/mojo/python/mojo)
