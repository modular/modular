...
The
[`examples/mojo/`](https://github.com/modular/modular/tree/modular/v26.2/mojo/examples)
...
- [`mojo` Python
  package](https://github.com/modular/modular/tree/modular/v26.2/mojo/python/mojo)
...
import GpuRequirements from '../_includes/gpu-requirements.mdx';
