...
Mojo's [`layout` package](https://docs.modular.com/api/mojo/layout/) provides a
...
- The [`Layout`](https://docs.modular.com/api/mojo/layout/layout/Layout/) struct
...
- The [`IntTuple`](https://docs.modular.com/api/mojo/layout/int_tuple/IntTuple/)
...
The
[`print_layout()`](https://docs.modular.com/api/mojo/layout/layout/print_layout/)
...
also provides an
[`idx2crd()`](https://docs.modular.com/api/mojo/layout/layout/Layout/#idx2crd)
...
[`IntTuple`](https://docs.modular.com/api/mojo/layout/int_tuple/IntTuple/) type.
...
The [`int_tuple`](https://docs.modular.com/api/mojo/layout/int_tuple/) package
provides a number of functions for working with `IntTuple`. For example, it
provides a
[`congruent()`](https://docs.modular.com/api/mojo/layout/int_tuple/congruent/)
...
[`row_major()`](https://docs.modular.com/api/mojo/layout/layout/Layout/#row_major)
and
[`col_major()`](https://docs.modular.com/api/mojo/layout/layout/Layout/#col_major)
...
[`tile_to_shape()`](https://docs.modular.com/api/mojo/layout/layout/tile_to_shape/)
...
[`blocked_product()`](https://docs.modular.com/api/mojo/layout/layout/blocked_product/)
...
[`make_ordered_layout()`](https://docs.modular.com/api/mojo/layout/layout/make_ordered_layout/)
