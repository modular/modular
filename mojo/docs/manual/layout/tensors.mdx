...
[`Array`](/docs/std/collections/array/Array/):
...
[`unsafe_memset()`](/docs/std/memory/memory/unsafe_memset/)
...
The
[`LayoutTensor.tile()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#tile)
...
The
[`LayoutTensorIter`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensorIter/)
...
[`tiled_iterator()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#tiled_iterator)
...
The
[`vectorize()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#vectorize)
...
[`distribute()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#distribute)
...
- [`copy_from()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#copy_from)
  copies data from a source tensor to the current tensor, which may be in a
  different memory space.
- [`copy_from_async()`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/#copy_from_async)
...
The
[`layout_tensor` package](https://docs.modular.com/api/mojo/layout/layout_tensor/)
