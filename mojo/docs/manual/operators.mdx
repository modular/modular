...
github_url: https://github.com/modular/modular/tree/main/mojo/examples/operators
---
...
proposal,
[Customizable Type Merging in Mojo](https://github.com/modular/modular/blob/main/mojo/proposals/custom-type-merging.md).
...
repo](https://github.com/modular/modular/tree/main/mojo/examples/operators).
...
(This decorator is now deprecated, conform to the `TrivialRegisterPassable` trait
instead.)
...
```mojo
@fieldwise_init
struct Complex(TrivialRegisterPassable):
    var re: Float64
    var im: Float64
```
...
[Writable](/mojo/std/format/Writable) trait. While we're at it, let's
also implement the [`Stringable`](/mojo/std/builtin/str/Stringable) trait so
