...
github_url: https://github.com/modular/modular/tree/modular/v26.1/mojo/examples/operators
---
...
proposal,
[Customizable Type Merging in Mojo](https://github.com/modular/modular/blob/modular/v26.1/mojo/proposals/custom-type-merging.md).
...
repo](https://github.com/modular/modular/tree/modular/v26.1/mojo/examples/operators).
