...
type](/mojo/manual/traits#register-passable) (like `Int`) or a
...
The
[`take_pointee()`](/mojo/std/memory/unsafe_pointer/UnsafePointer#take_pointee)
...
The
[`destroy_pointee()`](/mojo/std/memory/unsafe_pointer/UnsafePointer#destroy_pointee)
...
Calling
[`init_pointee_move_from(self, src)`](/mojo/std/memory/unsafe_pointer/UnsafePointer/#init_pointee_move_from)
