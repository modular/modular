...
[`mojo build --emit shared-lib`](/docs/cli/build#--emit-file_type) to generate a
...
2. [Variadic keyword arguments](/manual/functions/#variadic-keyword-arguments):
...
[`OwnedKwargsDict[PythonObject]`](/docs/std/collections/dict/OwnedKwargsDict) as
the last argument. A simple example looks like:
