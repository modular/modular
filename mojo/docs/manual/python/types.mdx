...
[`PythonObject`](/mojo/std/python/python_object/PythonObject) wrapper around
...
[`Python.dict()`](/mojo/std/python/python/Python#dict),
[`Python.list()`](/mojo/std/python/python/Python#list), and
[`Python.tuple()`](/mojo/std/python/python/Python#tuple) static methods.

For example, to create a Python dictionary, use the
[`Python.dict()`](/mojo/std/python/python/Python#dict) method:
...
With the [`Python.list()`](/mojo/std/python/python/Python#list) method, you
...
The [`Python.tuple()`](/mojo/std/python/python/Python#tuple) method creates a
...
[`Python.evaluate()`](/mojo/std/python/python/Python#evaluate) method. For
...
`PythonObject` implements the [`Writable`](/mojo/std/format/Writable)
trait. This allows you to print Python values using the built-in
[`print()`](/mojo/std/builtin/io/print) function, as shown in several of the
previous examples.
...
[`Python.type()`](/mojo/std/python/python/Python#type) method, which is
