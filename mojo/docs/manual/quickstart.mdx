...
[Mojo agent skills](/docs/tools/skills) give your AI tool
...
**API docs:** [Standard Library](/docs/lib)

Read about [learning Mojo with AI Agent skills](/docs/manual/tools/skills).
