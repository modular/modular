...
Mojo will generate a move initializer for you. You rarely need to
write your own custom move initializer. For more information,
see the section on
[move initializers](/docs/manual/lifecycle/life/#move-initializer).
...
In most cases, that's all you need to do. Mojo will generate a copy initializer
(`__init__(out self, *, copy: Self)` method) for you. You don't need to write
your own unless you need custom logic in the copy initializer; for example, if
your struct dynamically allocates memory. For more information, see the section
on [copy initializers](/docs/manual/lifecycle/life/#copy-constructor).
