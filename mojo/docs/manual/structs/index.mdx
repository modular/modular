...
def process_pair(pair: MyPair) raises:
    ...
...
def utility_function(argument: CustomType) raises:
    ...
...
( `__init__(out self, *, copy: Self)` method) for you. You don't need to write your
own unless you need custom logic in the copy constructor; for example, if your struct
...
[`comptime` members](/mojo/manual/parameters/#comptime-members)
...
[certain conventions](https://github.com/modular/modular/blob/modular/v26.2/mojo/stdlib/docs/style-guide.md#code-conventions):
