...
- The [`tile_layout.Layout`](/mojo/layout/tile_layout/Layout) struct
...
- [`Coord`](/mojo/layout/coord/Coord/) is a tuple-like container for
...
also provides an [`idx2crd()`](/mojo/layout/tile_layout/Layout#idx2crd)
...
[`Coord`](/mojo/layout/coord/Coord) type, a tuple-like structure that
...
values using the [`coord()`](/mojo/layout/coord/coord/) function:
...
The [`coord`](/mojo/layout/coord/) package provides a number of
...
[`row_major()`](/mojo/layout/tile_layout/row_major/) and
[`col_major()`](/mojo/layout/tile_layout/col_major/) functions are
...
The [`zipped_divide()`](/mojo/layout/tile_layout/zipped_divide/)
