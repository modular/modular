...
- The
  [`tile_layout.Layout`](https://docs.modular.com/api/mojo/layout/tile_layout/Layout/)
...
also provides an
[`idx2crd()`](https://docs.modular.com/api/mojo/layout/tile_layout/Layout/#idx2crd)
...
values using the [`coord`](/docs/std/utils/coord/coord/) comptime alias:
...
and
[`col_major()`](https://docs.modular.com/api/mojo/layout/tile_layout/col_major/)
