...
[`LayoutTensor`](https://docs.modular.com/api/mojo/layout/layout_tensor/LayoutTensor/).
`TileTensor` is more memory-efficient and makes it much easier to mix
compile-time and runtime dimensions. However, some operations that are supported
on `LayoutTensor` aren't yet supported on `TileTensor`. For these operations,
you can easily create a `LayoutTensor` from a `TileTensor` using
[`to_layout_tensor()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#to_layout_tensor).
...
def takes_scalar_tensor(
    tensor: TileTensor[DType.int32, Storage=PointerStorage[element_width=1], ...]
) -> Int:
...
[`load()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#load)
and
[`store()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#store)
...
[`Layout`](https://docs.modular.com/api/mojo/layout/tile_layout/Layout/) and a
block of memory to store the tensor data. A common way to allocate memory for a
`TileTensor` is to use an [`Array`](/docs/std/collections/array/Array/) or a
`List`:
...
`Array` to a `Span` representing the underlying memory. The span tracks
...
[`stack_allocation()`](https://docs.modular.com/api/mojo/layout/tile_tensor/stack_allocation/)
...
([`blocked_product()`](https://docs.modular.com/api/mojo/layout/tile_layout/blocked_product/))
or easily addressed by logical coordinates
([`zipped_divide()`](https://docs.modular.com/api/mojo/layout/tile_layout/zipped_divide/)).
...
The
[`TileTensor.tile()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#tile)
...
[`TileTensor` layouts](/docs/manual/tile-tensor/layouts/#nested-layouts) for how
to construct nested layouts with
[`row_major_nested()`](https://docs.modular.com/api/mojo/layout/tile_layout/row_major_nested/)
and
[`col_major_nested()`](https://docs.modular.com/api/mojo/layout/tile_layout/col_major_nested/).
...
The
[`vectorize()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#vectorize)
...
[`distribute()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#distribute)
...
The
[`split()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#split)
...
[`as_immut()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#as_immut)
...
[`copy_from()`](https://docs.modular.com/api/mojo/layout/tile_tensor/TileTensor/#copy_from)
method for copying tensor data. In addition, the
[`tile_io`](https://docs.modular.com/api/mojo/layout/tile_io/) module provides a
...
The [`tile_io` package](https://docs.modular.com/api/mojo/layout/tile_io/)
...
- [`GenericToSharedTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/GenericToSharedTileCopier/)
- [`SharedToGenericTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/SharedToGenericTileCopier/)
- [`GenericToLocalTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/GenericToLocalTileCopier/)
- [`LocalToGenericTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/LocalToGenericTileCopier/)
- [`SharedToLocalTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/SharedToLocalTileCopier/)
- [`LocalToSharedTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/LocalToSharedTileCopier/)

In addition to the synchronous tile copiers, the `tile_io` module currently
includes one *asynchronous* tile copier:

- [`GenericToSharedAsyncTileCopier`](https://docs.modular.com/api/mojo/layout/tile_io/GenericToSharedAsyncTileCopier/)
...
[Optimize custom ops for GPUs with Mojo](https://docs.modular.com/develop/custom-ops-matmul/).
