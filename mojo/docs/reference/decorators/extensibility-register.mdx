...
instances of
[`OutputTensor`](https://docs.modular.com/api/mojo/extensibility/managed_tensor_slice/#outputtensor)
and
[`InputTensor`](https://docs.modular.com/api/mojo/extensibility/managed_tensor_slice/#inputtensor),
respectively. These are both type aliases for specific configurations of
[`ManagedTensorSlice`](https://docs.modular.com/api/mojo/extensibility/managed_tensor_slice/ManagedTensorSlice),
