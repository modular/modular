...
Separate the summary from additional body text with a blank line.
Start the summary with a capital letter and end it with a period.
Avoid repeating the declaration name.
...
Mojo supports custom section labels. Common examples include
`Performance:`, `Safety:`, `Notes:`, and `See:`.
...
Use `Notes:` for additional information that doesn't fit other
sections.
