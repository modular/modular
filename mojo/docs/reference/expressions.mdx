...
The walrus operator introduces a new binding. It's most often used for
temporary values created as part of a statement, although the binding
remains available for the rest of its scope.
