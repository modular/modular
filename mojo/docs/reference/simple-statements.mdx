...
Omitting `var` declares the name just the same, but at function scope rather
than block scope. See
[Variables](/docs/manual/variables/#implicitly-declared-variables).
