...
- The Mojo standard library is now open source! Check out the
  [README](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/stdlib/README.md)
...
- `let` declarations now produce a compile time error instead of a warning, our
  next step in
  [removing let declarations](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/proposals/remove-let-decls.md).
