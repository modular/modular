...
- [`String`](/docs/std/collections/string/string/) and friends:
  ...
  - Added the `byte_length()` method to
    ...
    [`StringSlice`](/docs/std/collections/string/string_span/StringSlice/#byte_length),
    and
  ...
  - Added a
    [`StringSlice`](/docs/std/collections/string/string_span/StringSlice/#__init__)
...
- Miscellaneous:
  ...
  - The `rank` argument for
    [`algorithm.elementwise()`](https://docs.modular.com/api/mojo/max/algorithm/functional/elementwise/)
