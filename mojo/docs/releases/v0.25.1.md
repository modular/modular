...
- The new [`gpu` package](/docs/std/gpu/) provides low-level programming
  ...
  [`vector_addition.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0b2/max/examples/custom_ops/kernels/vector_addition.mojo)
  and
  [`top_k.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0b2/max/examples/custom_ops/kernels/top_k.mojo).
