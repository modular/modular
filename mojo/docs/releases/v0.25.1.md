...
- The new [`gpu` package](/docs/std/gpu/) provides low-level programming
  ...
  [MAX custom operation](https://docs.modular.com/develop/custom-ops/).
  ...
  [`vector_addition.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0/max/examples/custom_ops/kernels/vector_addition.mojo)
  and
  [`top_k.mojo`](https://github.com/modular/modular/blob/mojo/v1.0.0/max/examples/custom_ops/kernels/top_k.mojo).

- The [`layout` package](https://docs.modular.com/api/mojo/layout/) includes
