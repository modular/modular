...
- Check out the new [GPU basics](https://docs.modular.com/gpu/fundamentals/)
  section of the [Mojo Manual](/docs/manual/) and the
  [Get started with GPU programming with Mojo and the MAX Driver](https://docs.modular.com/gpu/intro-tutorial/)
...
- Some APIs in the [`gpu`](/docs/std/gpu/) package were enhanced to simplify
  ...
  - The [`gpu`](/docs/std/gpu/) package API documentation has been expanded, and
    ...
    [`layout`](https://docs.modular.com/api/mojo/layout/) package is underway,
...
- GPU programming changes:
  ...
  - You can now skip compiling a GPU kernel first before enqueueing it, and pass
    ...
    [`DeviceContext.compile_function()`](https://docs.modular.com/api/mojo/max/gpu/host/device_context/DeviceContext/#compile_function)
