...
- Parts of the Mojo standard library continue to be progressively open sourced!
  ...
  [Standard library
  source](https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/stdlib).
...
- Mojo can now use
  [user-declared `__merge_with__()` dunder methods](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/custom-type-merging.md)
...
- The [`StringLiteral`](/docs/std/builtin/string_literal/StringLiteral/) type
  ...
  [Fixing Simple Literals in Mojo](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/fixing-simple-literals.md).
