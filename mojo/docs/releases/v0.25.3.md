...
- Parts of the Mojo standard library continue to be progressively open sourced!
  ...
  [Standard library
  source](https://github.com/modular/modular/tree/mojo/v1.0.0/mojo/stdlib).

- Parts of the MAX AI kernels library continue to be progressively open sourced!
  Packages that are open sourced now include:

  - [`layout`](https://docs.modular.com/api/mojo/layout/)
  - [`linalg`](https://docs.modular.com/api/mojo/linalg/)

For more information, see the
[MAX AI kernels library reference](https://docs.modular.com/api/mojo/) and the
...
- Mojo can now use
  [user-declared `__merge_with__()` dunder methods](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/proposals/custom-type-merging.md)
...
- The [`StringLiteral`](/docs/std/builtin/string_literal/StringLiteral/) type
  ...
  [Fixing Simple Literals in Mojo](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/proposals/fixing-simple-literals.md).
