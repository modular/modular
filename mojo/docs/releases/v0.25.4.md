...
- The entire MAX Kernel library is now fully open sourced! For more information,
  see the [MAX AI kernels library reference](https://docs.modular.com/api/mojo/)
  and the
  [MAX AI kernels source](https://github.com/modular/modular/tree/mojo/v1.0.0/max/kernels).
...
- GPU programming enhancements and changes:
  ...
  - Primitives for working with NVIDIA Blackwell GPUs have been added, providing
    ...
    [`gpu.tcgen05`](https://docs.modular.com/api/mojo/max/gpu/compute/arch/tcgen05/)
