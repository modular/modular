...
- The entire MAX Kernel library is now fully open sourced! For more information,
  see the
  [MAX AI kernels library reference](https://docs.modular.com/max/api/kernels/)
  and the
  [MAX AI kernels source](https://github.com/modular/modular/tree/mojo/v1.0.0b2/max/kernels).
