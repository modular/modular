...
- Moved the
  [`comm`](https://github.com/modular/modular/tree/mojo/v1.0.0/max/kernels/src/comm)
...
- `mojo doc --validate-doc-strings` now emits a warning when an `fn` function is
  ...
  [`Raises` docstring](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/stdlib/docs/docstring-style-guide.md#raises).
