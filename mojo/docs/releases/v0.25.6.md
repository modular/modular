...
- You can now **`pip install mojo`**!
  ...
  making it easier to
  [extend your Python code with Mojo](/docs/manual/python/mojo-from-python). For
  more information, see the [Mojo install guide](/install/).
...
- Moved the
  [`comm`](https://github.com/modular/modular/tree/mojo/v1.0.0b2/max/kernels/src/comm)
...
- `mojo doc --validate-doc-strings` now emits a warning when an `fn` function is
  ...
  [`Raises` docstring](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/stdlib/docs/docstring-style-guide.md#errors).
