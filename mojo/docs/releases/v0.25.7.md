...
- Added a new document on
  [GPU block and warp operations and synchronization](https://docs.modular.com/gpu/block-and-warp/).
...
- `UnsafePointer` has been renamed to `LegacyUnsafePointer` and a new
  ...
  *Note*: `LegacyUnsafePointer` and `LegacyOpaquePointer` will eventually be
  ...
  [UnsafePointer v2 proposal](https://github.com/modular/modular/blob/mojo/v1.0.0/mojo/proposals/unsafe-pointer-v2.md#migration-guide-from-legacyunsafepointer-to-the-new-unsafepointer).
...
- [`memcpy()`](/docs/std/memory/memory/memcpy/) and
  [`parallel_memcpy()`](https://docs.modular.com/api/mojo/max/algorithm/memory/parallel_memcpy/)
...
- TMA (Tensor Memory Accelerator) types have been moved to a dedicated module.
  ...
  now available from
  [`gpu.host.nvidia.tma`](https://docs.modular.com/api/mojo/max/gpu/host/nvidia/tma/)
