...
- Added a new
  [Instance initialization deep dive](/docs/manual/lifecycle/object-initialization)
...
- Added a new [Generics](/docs/manual/generics/generics) page to the Mojo
...
- Mojo now supports the
  [`@align`](/docs/manual/decorators/align)`(N)` decorator to
...
- `trait` declarations no longer automatically inherit from
  ...
  Previously, the
  [`@explicit_destroy`](/docs/manual/decorators/explicit-destroy)
