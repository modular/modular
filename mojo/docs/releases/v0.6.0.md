...
- Mojo now has the ability to read raw bytes from a file using the
  [`read_bytes()`](/docs/std/builtin/file/FileHandle#read_bytes) method.
  For example:
...
[`read()`](/docs/std/builtin/file/FileHandle#read) and
[`read_bytes()`](/docs/std/builtin/file/FileHandle#read_bytes) methods on
