...
- The [Mojo Manual](/docs/manual/) is an all-new, complete Mojo user guide. It
  doesn't include *everything* about Mojo yet, but it includes a lot, and more
  than the original programming manual (now deprecated).

  Plus, the entire Mojo Manual and other Mojo docs are now
  [open-sourced on GitHub](https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/docs),
  and we'd love to accept contributions to help us improve them!
