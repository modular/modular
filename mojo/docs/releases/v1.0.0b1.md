...
- Split [operators page](/docs/manual/operators/) into separate pages; refreshed
  coverage and added [tutorial](/docs/manual/structs/operator-support/),
  operator tests, and new [reference page](/docs/reference/mojo-operators/).
...
- Several constructs deprecated in 26.2 are no longer accepted:
  ...
  - The legacy `__moveinit__` and `__copyinit__` method names are no longer
    ...
    [init unification](/docs/releases/v0.26.2#0-26-2-init-unification) in 26.2.
