...
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/trait_composition.md).
...
- ✅ **Parametric comptime values:** Compute parametric values, going beyond
  ...
  proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/parametric_alias.md).
...
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/where_clauses.md).
...
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/struct-extensions.md).
...
comparable](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/simd-comparable.md)
and the [string type
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/string-design.md).
...
design](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/collection-literal-design.md)
and [fixing simple literals
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/fixing-simple-literals.md).
...
proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/upgrading-trivial.md)
and [upgrading `@value`
decorator](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/upgrading-value-decorator.md).
...
- [Contributor
guide](https://github.com/modular/modular/blob/modular/v26.2/mojo/CONTRIBUTING.md)
