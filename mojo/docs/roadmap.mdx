...
[trait composition proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/trait_composition.md).
...
- ✅ **Parametric comptime values:** Compute parametric values, going beyond
  ...
  [parametric aliases proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/parametric_alias.md).
...
[where clauses proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/where_clauses.md).
...
refactoring. See the
[struct extension proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/struct-extensions.md).
...
instance, see
[making SIMD comparable](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/simd-comparable.md)
and the
[string type proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/string-design.md).
...
[collection literal design](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/collection-literal-design.md)
and
[fixing simple literals proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/fixing-simple-literals.md).
...
[upgrading "trivial" proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/upgrading-trivial.md)
and
[upgrading `@value` decorator](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/upgrading-value-decorator.md).
...
- [Contributor
guide](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/CONTRIBUTING.md)
