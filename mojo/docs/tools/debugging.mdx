...
the MAX framework,
[install the `modular` package](https://docs.modular.com/packages/), which
...
[GPU debugging](https://docs.modular.com/gpu/debugging/).
...
repo](https://github.com/modular/modular/tree/mojo/v1.0.0/mojo/examples).
