...
github_url: https://github.com/modular/modular/tree/mojo/v1.0.0/mojo/examples/testing
---
...
- Our GitHub repo contains an [example
  project](https://github.com/modular/modular/tree/mojo/v1.0.0/mojo/examples/testing)
