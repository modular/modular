...
github_url: https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/examples/testing
---
...
information, see the
[deprecation proposal](https://github.com/modular/modular/blob/mojo/v1.0.0b2/mojo/proposals/mojo-test-deprecation.md)
and
...
- Our GitHub repo contains an
  [example project](https://github.com/modular/modular/tree/mojo/v1.0.0b2/mojo/examples/testing)
