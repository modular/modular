...
github_url: https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/testing
---
...
information, see the
[deprecation proposal](https://github.com/modular/modular/blob/modular/v26.2/mojo/proposals/mojo-test-deprecation.md)
and
...
- Our GitHub repo contains an [example
  project](https://github.com/modular/modular/tree/modular/v26.2/mojo/examples/testing)
