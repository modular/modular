...
def gen_word_pairs[words: StaticString = words_en]() -> List[String]:
...
# ===-----------------------------------------------------------------------===#
@parameter
def bench_small_keys[
    s: StaticString, HasherType: Hasher
...
@parameter
def bench_long_key[s: StaticString, HasherType: Hasher](mut b: Bencher) raises:
    @always_inline
    @parameter
    def call_fn():
