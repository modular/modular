...
Notes:
    String stores data using UTF-8, and all operations (unless clearly noted)
    are intended to be fully Unicode compliant and maintain correct UTF-8
    encoded data. A handful of operations are known to not be Unicode / UTF-8
    compliant yet, but will be fixed as time permits.
"""
