...
struct StringSlice[mut: Bool, //, origin: Origin[mut=mut]](
    ...
    def replace(self, old: StringSlice, new: StringSlice) -> String:
        ...
        if old_len == 0:
            ...
            @parameter
            def _replace_interleave[W: Writer](mut writer: W):
                for s in self.codepoint_slices():
                    writer.write(new, s)
