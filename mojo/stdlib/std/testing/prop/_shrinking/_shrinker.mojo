...
@fieldwise_init
struct ShrinkResult[T: Copyable & ImplicitlyDeletable & Writable](Copyable):
    var value: Self.T
    var runs: Int


trait ShrinkOracle(ImplicitlyDeletable, Movable):
    def try_stream(mut self, stream: Stream) -> Bool:
        ...

    def best_stream[o: ImmOrigin, //](ref[o] self) -> ref[o] Stream:
        ...
