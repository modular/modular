...
fn _validate_utf8_simd_slice[
    ...
    ptr: UnsafePointer[UInt8, mut=False, **_], length: Int, mut iter_len: UInt
) -> Bool:
    ...
    while iter_len > 0 and (iter_len >= width or remainder):
        ...
        var valid_n4 = byte_types == n4_byte_types
        var valid_n3 = (byte_types & n3_mask) == n3_byte_types
        var valid_n2 = (byte_types & n2_mask) == n2_byte_types
...
fn _utf8_byte_type(b: SIMD[DType.uint8, _], /) -> __type_of(b):
    ...
    if is_compile_time():
        return 4 - (
            b.lt(0b1000_0000).cast[DType.uint8]()
            + b.lt(0b1100_0000).cast[DType.uint8]()
            + b.lt(0b1110_0000).cast[DType.uint8]()
            + b.lt(0b1111_0000).cast[DType.uint8]()
        )
    else:
