...
fn isclose[
    ...
    *,
    ...
    For boolean or integral dtypes, this performs exact equality. For floating-point
    dtypes, the following criteria apply:
    ...
    if symmetrical:
        ...
        in_range = abs(a - b) <= max(T(rtol) * max(abs(a), abs(b)), T(atol))
    else:
