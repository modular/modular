...
struct Span[
    ...
    *,
    ...
    alias _bitwidth = bit_width_of[T]()
    ...
    alias _dtype_Span = Span[Self._SIMD, origin, address_space=address_space]
    ...
    fn __contains__[
        ...
        self: Span[mut=False, U, address_space = AddressSpace.GENERIC, **_],
        value: U,
    ) -> Bool:
