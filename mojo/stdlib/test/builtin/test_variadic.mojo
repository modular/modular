...
def test_variadic_reverse_empty() raises:
    ...
    assert_equal(Variadic.size_types[_tup.element_types], 0)
    assert_equal(Variadic.size_types[ReversedVariadic], 0)


def test_variadic_reverse_odd() raises:
    var _tup = (String("hi"), Int(42), Float32(3.14))
    comptime ReversedVariadic = Variadic.reverse[*type_of(_tup).element_types]
    assert_equal(Variadic.size_types[_tup.element_types], 3)
    assert_equal(Variadic.size_types[ReversedVariadic], 3)
...
def test_variadic_reverse_even() raises:
    ...
    assert_equal(Variadic.size_types[_tup.element_types], 2)
    assert_equal(Variadic.size_types[ReversedVariadic3], 2)
...
def test_variadic_concat_empty() raises:
    ...
    assert_equal(Variadic.size_types[_tup.element_types], 0)
    assert_equal(Variadic.size_types[ConcattedVariadic], 0)
...
def test_variadic_concat_singleton() raises:
    ...
    assert_equal(Variadic.size_types[_tup.element_types], 3)
    assert_equal(Variadic.size_types[ConcattedVariadic], 4)
...
def test_variadic_concat_identity() raises:
    ...
    assert_equal(Variadic.size_types[_tup.element_types], 2)
    assert_equal(Variadic.size_types[ConcattedVariadic], 2)
...
def test_variadic_splatted_zero() raises:
    ...
    assert_equal(Variadic.size_types[splatted_variadic], 0)


def test_variadic_contains() raises:
    comptime variadic = Variadic.types[T=Writable, Int, String, Float32]
    assert_equal(Variadic.size_types[variadic], 3)
...
def test_variadic_contains_empty() raises:
    ...
    assert_equal(Variadic.size_types[variadic], 0)
    comptime ContainsWritable = Variadic.contains[Trait=Writable, ...]
    assert_false(ContainsWritable[Bool, variadic])
...
def test_zip_types_empty() raises:
    ...
    assert_equal(Variadic.size_types[v_zip[0]], 0)
    assert_equal(Variadic.size_types[v_zip[1]], 0)
...
def test_slice_types() raises:
    ...
    assert_equal(Variadic.size_types[variadic], 2)
...
def test_filter_types_exclude_one() raises:
    ...
    assert_equal(Variadic.size_types[without_int], 3)
...
def test_filter_types_keep_only() raises:
    ...
    assert_equal(Variadic.size_types[kept], 2)
...
def test_filter_types_exclude_many() raises:
    ...
    assert_equal(Variadic.size_types[filtered], 2)
...
def test_filter_types_chained() raises:
    ...
    assert_equal(Variadic.size_types[step2], 2)
...
def test_filter_types_empty_result() raises:
    ...
    assert_equal(Variadic.size_types[empty], 0)
