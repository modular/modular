...
def test_copy_trivial_wraparound() raises:
...
def test_realloc_trivial_wraparound() raises:
...
def test_extend_trivial_wraparound() raises:
...
def test_prepare_for_new_elements_trivial() raises:
