...
def test_static_int_tuple() raises:
    ...
    assert_equal(
        String(IndexList[3](1, 2, 3) * IndexList[3](4, 5, 6)),
        "(4, 10, 18)",
    )

    assert_equal(
        String(IndexList[4](1, 2, 3, 4) - IndexList[4](4, 5, 6, 7)),
        "(-3, -3, -3, -3)",
    )

    assert_equal(String(IndexList[2](10, 11) // IndexList[2](3, 4)), "(3, 2)")
    ...
    assert_equal(String(IndexList[2]((1, 2))), "(1, 2)")
