...
#   Path:   tests/data/miscellaneous/long_strings_flag_disabled.py
#
# ===----------------------------------------------------------------------=== #
...
fmt_string2 = "But what about when the string is {} but {}".format(
    "short",
    "the method call is really really really really really really really really"
    " long?",
)
...
arg_comment_string = print(
    ...
    " reformatted string's enclosing left parentheses.",  # This comment stays on the bottom.
    "Arg #2",
    "Arg #3",
    "Arg #4",
    "Arg #5",
...
func_with_bad_comma(
    "This is a really long string argument to a function that has a trailing"
    " comma which should NOT be there.",
)

func_with_bad_comma(
    "This is a really long string argument to a function that has a trailing"
    " comma which should NOT be there.",  # comment after comma
)
